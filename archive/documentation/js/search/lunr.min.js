!(function() {
  ...
  (z.version = '2.3.2'),
    ...
    (z.Pipeline.registerFunction = function(e, t) {
      t in this.registeredFunctions && z.utils.warn('Overwriting existing registered function: ' + t),
        (e.label = t),
    ...
    (z.Pipeline.warnIfFunctionNotRegistered = function(e) {
      (e.label && e.label in this.registeredFunctions) ||
        z.utils.warn('Function is not registered with pipeline. This may cause problems when serialising the index.\n', e);
    }),
    ...
    (z.Pipeline.prototype.run = function(e) {
      for (var t = this._stack.length, r = 0; r < t; r++) {
        for (var i = this._stack[r], n = [], s = 0; s < e.length; s++) {
          var o = i(e[s], s, e);
          if (void 0 !== o && '' !== o)
            if (o instanceof Array) for (var a = 0; a < o.length; a++) n.push(o[a]);
            else n.push(o);
        }
        e = n;
      }
    ...
    (c = { icate: 'ic', ative: '', alize: 'al', iciti: 'ic', ical: 'ic', ful: '', ness: '' }),
    (e = '[aeiouy]'),
    (r = '[^aeiou][^aeiouy]*'),
    ...
    (i = function(e) {
      ...
      if (
        ...
        (s = m),
        (n = y).test(e) ? (e = e.replace(n, '$1$2')) : s.test(e) && (e = e.replace(s, '$1$2')),
        (s = x),
        (n = g).test(e))
      ) {
        var u = n.exec(e);
        ...
        (t = (u = s.exec(e))[1]),
          (s = p).test(t) &&
            ((o = Q),
            (a = k),
            (s = w).test((e = t)) ? (e += 'e') : o.test(e) ? ((n = v), (e = e.replace(n, ''))) : a.test(e) && (e += 'e'));
      }
    ...
    (z.TokenSet.fromFuzzyString = function(e, t) {
      for (var r = new z.TokenSet(), i = [{ node: r, editsRemaining: t, str: e }]; i.length; ) {
        var n,
          ...
          a = i.pop();
        if (0 < a.str.length)
          (s = a.str.charAt(0)) in a.node.edges ? (n = a.node.edges[s]) : ((n = new z.TokenSet()), (a.node.edges[s] = n)),
            1 == a.str.length ? (n.final = !0) : i.push({ node: n, editsRemaining: a.editsRemaining, str: a.str.slice(1) });
        if (0 < a.editsRemaining && 1 < a.str.length)
          (s = a.str.charAt(1)) in a.node.edges ? (o = a.node.edges[s]) : ((o = new z.TokenSet()), (a.node.edges[s] = o)),
            a.str.length <= 2 ? (o.final = !0) : i.push({ node: o, editsRemaining: a.editsRemaining - 1, str: a.str.slice(2) });
        ...
        if (0 < a.editsRemaining && 1 < a.str.length) {
          var c,
            h = a.str.charAt(0),
            d = a.str.charAt(1);
          d in a.node.edges ? (c = a.node.edges[d]) : ((c = new z.TokenSet()), (a.node.edges[d] = c)),
            1 == a.str.length ? (c.final = !0) : i.push({ node: c, editsRemaining: a.editsRemaining - 1, str: h + a.str.slice(2) });
        }
      }
      return r;
    }),
          ...
          for (var m = 0; m < p.length; m++) {
            ...
            for (y = 0; y < u.fields.length; y++) {
              var w = x[(R = u.fields[y])],
                ...
                S = new z.Set(Q);
              if (
                (u.presence == z.Query.presence.REQUIRED && ((c = c.union(S)), void 0 === s[R] && (s[R] = z.Set.complete)),
    ...
    (z.Builder.prototype.createFieldVectors = function() {
      for (var e = {}, t = Object.keys(this.fieldTermFrequencies), r = t.length, i = Object.create(null), n = 0; n < r; n++) {
        for (
          ...
          void 0 === i[x] ? ((y = z.idf(this.invertedIndex[x], this.documentCount)), (i[x] = y)) : (y = i[x]),
    ...
    (z.Query.prototype.clause = function(e) {
      return (
        ...
        e.wildcard & z.Query.wildcard.LEADING && e.term.charAt(0) != z.Query.wildcard && (e.term = '*' + e.term),
        e.wildcard & z.Query.wildcard.TRAILING && e.term.slice(-1) != z.Query.wildcard && (e.term = e.term + '*'),
    ...
    (z.Query.prototype.isNegated = function() {
      for (var e = 0; e < this.clauses.length; e++) if (this.clauses[e].presence != z.Query.presence.PROHIBITED) return !1;
      return !0;
    }),
