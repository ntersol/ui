  ...
  function (t, n, r) {
    ...
    t.exports = function (t, n) {
      ...
      return function (n, c, v) {
        for (
          var g, y, d = o(n), x = i(d), S = e(c, v, 3), b = u(x.length), m = 0, _ = r ? h(n, b) : f ? h(n, 0) : void 0;
          b > m;
          m++
        )
  ...
  function (t, n, r) {
    ...
    t.exports =
      ...
      function (t, n) {
        var r;
        return (
          null !== t ? ((c.prototype = e(t)), (r = new c()), (c.prototype = null), (r[u] = t)) : (r = f()),
          void 0 === n ? r : i(r, n)
        );
      };
  },
    ...
    t.exports = function (t, n, r, v, g, y, d) {
      ...
      if (
        (N &&
          ...
          b.next &&
          (a(b, _, !0), e || 'function' == typeof b[l] || u(b, l, h)),
        M &&
          w &&
          'values' !== w.name &&
          ((O = !0),
        ...
        if (((x = { values: M ? E : m('values'), keys: y ? E : m('keys'), entries: P }), d))
          for (S in x) S in F || o(F, S, x[S]);
  ...
  function (t, n, r) {
    var e = r(5),
      ...
      Y = function (t) {
        ...
        return (
          !(this === G && i(D, t) && !i(W, t)) && (!(n || !i(this, t) || !i(D, t) || (i(this, k) && this[k][t])) || n)
        );
      },
      B = function (t, n) {
      ...
      $ = function (t) {
        for (var n, r = t === G, e = A(r ? W : b(t)), o = [], u = 0; e.length > u; )
    ...
    t.exports = {
      set:
        ...
        ('__proto__' in {}
          ? (function (t, n, e) {
              try {
                (e = r(23)(Function.call, r(40).f(Object.prototype, '__proto__').set, 2))(t, []),
    ...
    r(43)('split', 2, function (t, n, e) {
      ...
      if (
        ...
        e = function (t, n) {
          ...
          return (
            v === r.length ? (!s && y.test('')) || p.push('') : p.push(r.slice(v)), p.length > g ? p.slice(0, g) : p
          );
        };
      } else
    ...
    e(
      ...
      'Number',
      {
        toFixed: function (t) {
          ...
          return (y =
            a > 0
              ? g + ((c = y.length) <= a ? '0.' + u.call('0', a - c) + y : y.slice(0, c - a) + '.' + y.slice(c - a))
              : g + y);
        },
      },
    );
      ...
      'Array',
      {
        from: function (t) {
          ...
          if ((y && (g = e(g, v > 2 ? arguments[2] : void 0, 2)), void 0 == x || (h == Array && c(x))))
            ...
            for (l = x.call(p), r = new h(); !(i = l.next()).done; d++)
    ...
    if (
      ...
      a = function (t, n) {
        ...
        return !r && e && t.constructor === a && o
          ? t
          : i(
              v ? new s(e && !o ? t.source : t, n) : s((e = t instanceof a) ? t.source : t, e && o ? f.call(t) : n),
              r ? this : l,
              a,
            );
      };
