          ...
          function a(t) {
            if (t) {
              ...
              if (a) {
                ...
                (a = t.match(/^rgba?\(\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/i))
              ) {
          ...
          (o.prototype = {
            ...
            mix: function(t, e) {
              var i = this,
                ...
                l = 1 - s;
              return this.rgb(s * i.red() + l * n.red(), s * i.green() + l * n.green(), s * i.blue() + l * n.blue()).alpha(
                i.alpha() * a + n.alpha() * (1 - a),
              );
            },
            toJSON: function() {
              return this.rgb();
              ...
              t.controllers.line = t.DatasetController.extend({
                ...
                calculatePointY: function(t, e, i) {
                  ...
                  if (l.options.stacked) {
                    for (n = 0; n < i; n++)
                      if (
                        ((a = r.data.datasets[n]), 'line' === (o = r.getDatasetMeta(n)).type && o.yAxisID === l.id && r.isDatasetVisible(n))
                      ) {
                ...
                draw: function() {
                  var t = this.chart,
                    ...
                    s = 0;
                  for (
                    o.canvas.clipArea(t.ctx, a), e(this.getDataset(), t.options) && i.dataset.draw(), o.canvas.unclipArea(t.ctx);
                    s < r;
                    ++s
                  )
                    n[s].draw(a);
                ...
                setHoverStyle: function(t) {
                  var e = this.chart.data.datasets[t._datasetIndex],
                    ...
                    a = t._model;
                  (a.radius =
                    n.hoverRadius || o.valueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius)),
                    (a.backgroundColor =
                      n.hoverBackgroundColor ||
                      o.valueAtIndexOrDefault(e.pointHoverBackgroundColor, i, o.getHoverColor(a.backgroundColor))),
                    (a.borderColor =
                      n.hoverBorderColor || o.valueAtIndexOrDefault(e.pointHoverBorderColor, i, o.getHoverColor(a.borderColor))),
              ...
              a.extend(t.prototype, {
                ...
                updateLayout: function() {
                  !1 !== l.notify(this, 'beforeLayout') &&
                    (r.update(this, this.width, this.height), l.notify(this, 'afterScaleUpdate'), l.notify(this, 'afterLayout'));
                },
                ...
                destroy: function() {
                  ...
                  o && (n.unbindEvents(), a.canvas.clear(n), s.releaseContext(n.ctx), (n.canvas = null), (n.ctx = null)),
                    l.notify(n, 'destroy'),
                ...
                eventHandler: function(t) {
                  ...
                  if (!1 !== l.notify(e, 'beforeEvent', [t])) {
                    ...
                    return (
                      a ? e.render(a) : n && !e.animating && (e.stop(), e.render(e.options.hover.animationDuration, !0)),
                      (e._bufferedRender = !1),
            ...
            update: function(t, e, i) {
              if (t) {
                ...
                n.each(h.concat(f, g, p), function(t) {
                  var e,
                    i = t.isHorizontal();
                  i ? ((e = t.update(t.fullWidth ? v : M, k)), (w -= e.height)) : ((e = t.update(y, w)), (M -= e.width)),
                    ...
                    l.maxTicksLimit && (a = l.maxTicksLimit),
                      s &&
                        ...
                        (h + l.autoSkipPadding) * u > r.width - (r.paddingLeft + r.paddingRight) &&
                          (e = 1 + Math.floor(((h + l.autoSkipPadding) * u) / (r.width - (r.paddingLeft + r.paddingRight)))),
                  ...
                  if (a.display) {
                    ...
                    if (
                      (o.each(m, function(i, n) {
                        if (!o.isNullOrUndef(i.label)) {
                          ...
                          if (p) {
                            ...
                            var E,
                              H = 'left' === a.position;
                            d.mirror ? ((z = H ? 'left' : 'right'), (E = W)) : ((z = H ? 'right' : 'left'), (E = k + W)),
                      ...
                      var F,
                        ...
                        L = r(f) / 2;
                      if (p)
                        (F = e.left + (e.right - e.left) / 2), (O = 'bottom' === a.position ? e.bottom - L - S.bottom : e.top + L + S.top);
                      else {
                ...
                update: function(e) {
                  ...
                  if (I.length) {
                    ...
                    C.filter &&
                      ...
                      'right' === p
                        ? (d -= s.width)
                        : 'center' === p && ((d -= s.width / 2) + s.width > u.width && (d = u.width - s.width), d < 0 && (d = 0)),
          ...
          n._set('global', {
            ...
            (e.exports = a.extend({
              ...
              inRange: function(t, e) {
                ...
                if (i) {
                  for (
                    var n = o.getAngleFromPoint(i, { x: t, y: e }), a = n.angle, r = n.distance, s = i.startAngle, l = i.endAngle;
                    l < s;
                ...
                for (
                  ...
                  (e = u[t]),
                    ...
                    0 === t
                      ...
                      : ((i = -1 === c ? i : u[c]),
                        n.skip || ((c !== t - 1 && !l) || -1 === c ? s.moveTo(n.x, n.y) : o.canvas.lineTo(s, i._view, e._view), (c = t)));
                s.stroke(), s.restore();
              },
            }));
        },
            ...
            a = {
              ...
              merge: function(t, e, i) {
                ...
                for (n = (i = i || {}).merger || a._merger, o = 0; o < d; ++o)
                  if (((e = u[o]), a.isObject(e))) for (l = 0, s = (r = Object.keys(e)).length; l < s; ++l) n(r[l], t, e, i);
                return t;
              },
                    ...
                    for (t.beginPath(), r = 0, s = p + !!o; r < s; ++r)
                      (h = i((u = e[(l = r % p)]._view), l, n)),
                        ...
                        f && g
                          ...
                          : x && y && (m ? (f && v.push(u), g && b.push(h)) : (c(t, v, b, x, y), (x = y = 0), (v = []), (b = [])));
              ...
              if (e.display) {
                ...
                o.each(t.legendItems, function(n, l) {
                  ...
                  y
                    ...
                    : _ + k > t.bottom && ((C = d.x = C + t.columnWidths[d.line] + i.padding), (_ = d.y = t.top + i.padding), d.line++),
                    (function(t, i, n) {
                      if (!(isNaN(b) || b <= 0)) {
                        c.save(),
                    ...
                    a.each(n, function(n, o) {
                      ...
                      i.isDatasetVisible(o) &&
                        ...
                        a.each(n.data, function(i, n) {
                          ...
                          isNaN(a) ||
                            s.data[n].hidden ||
                            ((d[n] = d[n] || 0), (c[n] = c[n] || 0), e.relativePoints ? (d[n] = 100) : a < 0 ? (c[n] += a) : (d[n] += a));
                        });
                    }),
                      a.each(l, function(e) {
              ...
              buildTicks: function() {
                var t = this,
                  ...
                  o = (t.ticks = (function(t, e) {
                    ...
                    var u = 1;
                    i < 1 && ((u = Math.pow(10, i.toString().length - 2)), (r = Math.round(r * u) / u), (s = Math.round(s * u) / u)),
              ...
              i = t.Scale.extend({
                ...
                getPixelForValue: function(e) {
                  ...
                  return (
                    ...
                    e !== o &&
                      (0 === o && ((i -= h = n.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize)), (o = c)),
              ...
              c =
                ...
                (function(t, e, i, n) {
                  ...
                  for (a = u.indexOf(t); a < d - 1; ++a)
                    if (((r = (o = l[u[a]]).steps ? o.steps[o.steps.length - 1] : s), o.common && Math.ceil((i - e) / (r * o.size)) <= n))
                      return u[a];
                  return u[d - 1];
                })(d.minUnit, t, e, i),
              h = p(c),
          ...
          e.exports = function(t) {
            var e = t.Scale.extend({
              ...
              update: function() {
                var e = this.options;
                return (
                  e.time && e.time.format && console.warn('options.time.format is deprecated and replaced by options.time.parser.'),
                  ...
                  (y._table = (function(t, e, i, n) {
                    ...
                    for (d.push(i), a = 0, o = d.length; a < o; ++a)
                      (l = d[a + 1]),
                        (r = d[a - 1]),
                        (s = d[a]),
                        (void 0 !== r && void 0 !== l && Math.round((l + r) / 2) === s) || u.push({ time: s, pos: a / (o - 1) });
                    return u;
              ...
              getPixelForValue: function(t, e, i) {
                var n = null;
                if ((void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = g(t, this)), null !== n))
  ...
  b.extend(p.prototype, {
    _modelize: function(t, e, n) {
      ...
      return {
        ...
        positioner: ((a = this._el),
        a instanceof l.elements.Arc ? s : a instanceof l.elements.Point ? d : a instanceof l.elements.Rectangle ? c : h),
    ...
    update: function(t) {
      ...
      b.options.resolve([o.display, !0], t, i) &&
        ...
        (r = (a = b.isNullOrUndef(n) ? [] : v.toTextLines(n)).length ? this._modelize(a, o, t) : null)),
        (this._model = r);
    },
    draw: function(t) {
      var e,
      ...
      p &&
        ...
        (u = -o / 2),
        (e = {
          frame: { x: (s = -l / 2) - i.left, y: u - i.top, w: l + i.width, h: o + i.height },
        ...
        (n = (function(t, e, n) {
          ...
          return (f *= r * c), (d *= i * c), (f += e.offset * r), (d += e.offset * i), { x: a.x + f, y: a.y + d };
        })(this._el, p, e.frame)),
        this._hitbox.update(n, e.frame, p.rotation),
        g.save(),
        p.clip && ((a = t.chartArea), g.beginPath(), g.rect(a.left, a.top, a.right - a.left, a.bottom - a.top), g.clip()),
        ...
        (h || (y && x)) &&
          (f.beginPath(),
          b.canvas.roundedRect(f, m(d.x) - x / 2, m(d.y) - x / 2, m(d.w) + x, m(d.h) + x, c.borderRadius),
          f.closePath(),
          h && ((f.fillStyle = h), f.fill()),
          y && x && ((f.strokeStyle = y), (f.lineWidth = x), (f.lineJoin = 'miter'), f.stroke())),
        (function(t, e, n, a) {
          var r,
            i,
            o,
  ...
  function g(t, e) {
    ...
    if (i.enter || i.leave) {
      ...
      (n = r.hovered),
        ...
        (u = a),
        ((s = n) || u) &&
          (s ? (u ? s.label !== u.label && (d = f = !0) : (d = !0)) : (f = !0), d && x(o, l.leave, s), f && x(o, l.enter, u));
    }
  }
          ...
          (o = y[i]),
            d && o && !o.hidden && !o._model.skip
              ? (f.push((l = new p(h, g, o, i))),
                l.update((l.$context = { active: !1, chart: t, dataIndex: i, dataset: c, datasetIndex: s })))
              : (l = null),
            (o[w] = l);
        g.restore(),
