...
(function() {
  ...
  function ua(m, s, q) {
    ...
    s.getAttribute('state') !== q &&
      ...
      (s.innerHTML = "<img style='height:95%;' src='" + eb[q].image + "' alt='" + m._cultureInfo[q + 'Text'] + "' />"));
  }
  function Ma() {
      ...
      : this.parent &&
        ...
        (null === v
          ...
          : 0 < this.parent.themeOptions[s].length &&
            ((v = Math.min(this.parent.themeOptions[s].length - 1, v)), (m = this.parent.themeOptions[s][v])));
    this.themeOptions = m;
    ...
    if (y(this.options.margin) && m.options.subtitles)
      for (var q = m.options.subtitles, v = 0; v < q.length; v++)
        if (
          ...
          ((y(q[v].verticalAlign) && 'top' === this.verticalAlign) || q[v].verticalAlign === this.verticalAlign) &&
  ...
  var ba = 20,
    ...
    Sa = {
      ...
      subtitles: [
        { fontFamily: Ea, fontSize: z, fontColor: fa, fontWeight: 'normal', verticalAlign: 'top', margin: 5 },
      ],
      data: [
        {
  ...
  Ea = {
    ...
    title: { fontFamily: Ea, fontSize: 32, fontColor: fa, fontWeight: 'normal', verticalAlign: 'top', margin: 5 },
    subtitles: [{ fontFamily: Ea, fontSize: z, fontColor: fa, fontWeight: 'normal', verticalAlign: 'top', margin: 5 }],
    toolbar: {
  ...
  var ba = 20,
    ...
    xa = {
      ...
      dark2: {
        ...
        subtitles: [
          { fontFamily: x, fontSize: z, fontColor: fa, fontWeight: 'normal', verticalAlign: 'top', margin: 5 },
        ],
        toolbar: {
          backgroundColor: '#666666',
          backgroundColorOnHover: '#FF7372',
        ...
        (s = F.shift()),
          '#' === s || '0' === s
            ? 0 < m.length && 0 !== Number(m.join(''))
              ? ((x += m.shift()), (I = !0))
              : '0' === s && ((x += '0'), (I = !0))
            : 1 < s.length && (('"' === s[0] && '"' === s[s.length - 1]) || ("'" === s[0] && "'" === s[s.length - 1]))
  ...
  Y.prototype.set = function(m, s, q) {
    ...
    if ('options' === m) this.createUserOptions(s);
      ...
      v.hasOwnProperty(m) ||
      (v.publicProperties && v.publicProperties.hasOwnProperty(m) && 'readWrite' === v.publicProperties[m])
    )
      this.options._isPlaceholder && this.createUserOptions(), (this.options[m] = s);
    else {
      window.console &&
        (v.publicProperties && v.publicProperties.hasOwnProperty(m) && 'readOnly' === v.publicProperties[m]
  ...
  Y.prototype.addTo = function(m, s, q, v) {
    ...
    y.hasOwnProperty(m) ||
    (y.publicProperties && y.publicProperties.hasOwnProperty(m) && 'readWrite' === y.publicProperties[m])
      ...
      : window.console &&
        (y.publicProperties && y.publicProperties.hasOwnProperty(m) && 'readOnly' === y.publicProperties[m]
          ? window.console.log('Property "' + m + '" is read-only.')
          : window.console.log('Property "' + m + '" doesn\'t exist. Please check for typo.'));
  };
        ...
        (this.options = 'undefined' === typeof m ? {} : m),
          ...
          this.optionsName
            ...
            : (s = this._defaultsKey) && 0 !== s.length
              ? ((v = s.charAt(0).toLowerCase()), 1 < s.length && (v = v.concat(s.slice(1))), (s = v))
              : (s = void 0),
          (m[s] = this.options);
  };
  ...
  Ha.prototype.render = function() {
    if (this.text) {
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? (null === this.maxWidth && (this.maxWidth = v.width - 4 - R * ('center' === this.horizontalAlign ? 2 : 1)),
          (F = 0.5 * v.height - this.margin - 2),
          (z = 0))
        : 'center' === this.verticalAlign &&
          ('left' === this.horizontalAlign || 'right' === this.horizontalAlign
            ? (null === this.maxWidth && (this.maxWidth = v.height - 4), (F = 0.5 * v.width - this.margin - 2))
            : 'center' === this.horizontalAlign &&
      ...
      y(this.padding) || 'number' !== typeof this.padding
        ? y(this.padding) ||
          ...
          ((I = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0),
          (I += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0),
          (I *= 1.25))
        : (I = 2.5 * this.padding);
  ...
  Ka.Chart = (function() {
    ...
    function z(a, f, b, c, e, g, h, l, t, k) {
      ...
      t && 0 < h.thickness
        ...
        : 0 < h.thickness && (a.moveTo(f, b + r), a.lineTo(c, b + r), a.moveTo(f, e - r), a.lineTo(c, e - r));
      a.stroke();
      a.restore();
    }
    ...
    function C(a, f, b, c, e, g) {
      ...
      this.options.scaleBreaks &&
        (this.scaleBreaks = new I(this.chart, this.options.scaleBreaks, ++this.chart._eventManager.lastObjectId, this));
      this.stripLines = [];
      if (this.options.stripLines && 0 < this.options.stripLines.length)
        for (a = 0; a < this.options.stripLines.length; a++)
          this.stripLines.push(
            new fa(this.chart, this.options.stripLines[a], a, ++this.chart._eventManager.lastObjectId, this),
          );
                                                          ...
                                                          : 'rangeBar' === t.type
                                                            ...
                                                            : 'rangeArea' === t.type
                                                              ...
                                                              : 'rangeSplineArea' === t.type
                                                                ? (k = this.renderRangeSplineArea(t))
                                                                : 'waterfall' === t.type
                                                                  ? (k = this.renderWaterfall(t))
                                                                  : 'boxAndWhisker' === t.type &&
                                                                    (k = this.renderBoxAndWhisker(t));
          ...
          for (t = 0; t < l.dataPoints.length; t++) {
            ...
            if (0 < t) {
              ...
              null !== e &&
                ...
                (a.axisY.logarithmic
                  ? ((w = e / l.dataPoints[t - 1].y), 1 > w && (w = 1 / w), f.minDiff > w && 1 !== w && (f.minDiff = w))
                  : ((w = e - l.dataPoints[t - 1].y), 0 > w && (w *= -1), f.minDiff > w && 0 !== w && (f.minDiff = w)));
            }
            if (c < n && !k) null !== e && (p = c);
            else {
              if (!k && ((k = !0), 0 < t)) {
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          for (n = 0; n < p.dataPoints.length; n++) {
            ...
            if (0 < n) {
              ...
              null !== e &&
                ...
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((m = e / p.dataPoints[n - 1].y), 1 > m && (m = 1 / m), f.minDiff > m && 1 !== m && (f.minDiff = m))
                  : ((m = e - p.dataPoints[n - 1].y), 0 > m && (m *= -1), f.minDiff > m && 0 !== m && (f.minDiff = m)));
            }
        ...
        for (n in h)
          h.hasOwnProperty(n) &&
            ...
            n < b.viewPortMin ||
              n > b.viewPortMax ||
              (a < f.viewPortMin && (f.viewPortMin = Math.min(a, t)), a > f.viewPortMax && (f.viewPortMax = a)));
        for (n in l)
          l.hasOwnProperty(n) &&
            !isNaN(n) &&
            ((a = l[n]),
    ...
    q.prototype._processStacked100PlotUnit = function(a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, h = !1, l = !1, t = [], k = 0;
          ...
          for (p = 0; p < r.dataPoints.length; p++) {
            ...
            if (0 < p) {
              ...
              y(e) ||
                ...
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((u = e / r.dataPoints[p - 1].y), 1 > u && (u = 1 / u), f.minDiff > u && 1 !== u && (f.minDiff = u))
                  : ((u = e - r.dataPoints[p - 1].y), 0 > u && (u *= -1), f.minDiff > u && 0 !== u && (f.minDiff = u)));
            }
            if (c < m && !n) null !== e && (w = c);
            else {
              if (!n && ((n = !0), 0 < p)) {
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          ...
          for (r = 0; r < k.dataPoints.length; r++) {
            ...
            0 < r &&
              (a.axisX.logarithmic
                ? ((w = c / k.dataPoints[r - 1].x), 1 > w && (w = 1 / w), b.minDiff > w && 1 !== w && (b.minDiff = w))
                : ((w = c - k.dataPoints[r - 1].x), 0 > w && (w *= -1), b.minDiff > w && 0 !== w && (b.minDiff = w)),
              e &&
    ...
    q.prototype._processSpecificPlotUnit = function(a) {
      if ('waterfall' === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          if ((l.dataPoints[t].x && l.dataPoints[t].x.getTime) || 'dateTime' === l.xValueType) g = !0;
          for (t = 0; t < l.dataPoints.length; t++)
            'undefined' !== typeof l.dataPoints[t].isCumulativeSum && !0 === l.dataPoints[t].isCumulativeSum
              ...
              : 'undefined' !== typeof l.dataPoints[t].isIntermediateSum && !0 === l.dataPoints[t].isIntermediateSum
          ...
          for (t = 0; t < l.dataPoints.length; t++)
            if (
              ...
              0 < t &&
                (a.axisX.logarithmic
                  ? ((p = c / l.dataPoints[t - 1].x), 1 > p && (p = 1 / p), b.minDiff > p && 1 !== p && (b.minDiff = p))
                  : ((p = c - l.dataPoints[t - 1].x), 0 > p && (p *= -1), b.minDiff > p && 0 !== p && (b.minDiff = p)),
                null !== e &&
                  null !== l.dataPoints[t - 1].y &&
                  (a.axisY.logarithmic
              ...
              if (!(4 > v.dataPoints.length))
                for (r = 0; r < v.dataPoints.length; r++)
                  if (
                    (c &&
                      ((p =
                        ((n + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                    ...
                    if ((k = 'waterfall' === a.type ? v.dataPointEOs[r].cumulativeSum : v.dataPoints[r].y) && k.length)
                      ...
                      y(k) ||
                        ((p = Math.floor((k - l) / q)), k < f[p].min && (f[p].min = k), k > f[p].max && (f[p].max = k));
                  }
            }
        }
      }
            ...
            for (l = 0; l < Math.min(g.length, this._axes[h].scaleBreaks.maxNumberOfAutoBreaks); l++)
              (c = a(
                ...
                this._axes[h].scaleBreaks.autoBreaks.push(
                  new ba(this, 'autoBreaks', c, l, ++this._eventManager.lastObjectId, this._axes[h].scaleBreaks),
                ),
    ...
    q.prototype.getDataPointAtXY = function(a, f, b) {
      ...
      for (b = 0; b < c.length; b++)
        if (
          ...
          if (((e = ja('markerSize', c[b].dataPoint, c[b].dataSeries) || 8), c[b].distance <= e / 2)) {
            f = !0;
            break;
          }
      for (b = 0; b < c.length; b++)
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            ...
            'inside' !== u
              ? ((e = b.y1),
                ...
                0 < q
                  ? ((n = k.point.y - t - h - c),
                    n < e && ((n = 'auto' === u ? Math.max(k.point.y, e) + h + c : e + h + c), (x = n + t > k.point.y)))
                  : ((n = k.point.y + h + c),
                    n > g - t - h - c &&
                      ((n = 'auto' === u ? Math.min(k.point.y, g) - t - h - c : g - t - h - c), (x = n < k.point.y))))
              : ((e = Math.max(k.bounds.y1, b.y1)),
                ...
                0 < q
                  ? ((n = Math.max(k.point.y, c) - t / 2),
                    n < e && ('bubble' === r || 'scatter' === r) && (n = Math.max(k.point.y - t - h, b.y1 + h)))
              ...
              'inside' !== u
                ? ((h = b.x1),
                  ...
                  0 > q
                    ? ((p = k.point.x - l - e - c),
                      p < h &&
                        ((p = 'auto' === u ? Math.max(k.point.x, h) + e + c : h + e + c), (x = p + l > k.point.x)))
                    : ((p = k.point.x + e + c),
                      p > g - l - e - c &&
                        ((p = 'auto' === u ? Math.min(k.point.x, g) - l - e - c : g - l - e - c), (x = p < k.point.x))))
          ...
          D &&
            ('inside' !== u &&
              ((0 > r.indexOf('bar') && ('error' !== r || !k.axisSwapped) && k.point.x > b.x1 && k.point.x < b.x2) ||
                !x) &&
              ((0 > r.indexOf('column') && ('error' !== r || k.axisSwapped) && k.point.y > b.y1 && k.point.y < b.y2) ||
                !x)) &&
            ((f.lineWidth = D),
            ...
            0 <= r.indexOf('bar') || ('error' === r && k.axisSwapped)
              ...
              : 0 <= r.indexOf('column') || ('error' === r && !k.axisSwapped)
                ? f.lineTo(p + l / 2, n + ((0 < k.direction ? t : -t) + ('horizontal' === Q ? t : -t)) / 2)
                : f.lineTo(p + l / 2, n + ((n < k.point.y ? t : -t) + ('horizontal' === Q ? t : -t)) / 2),
            f.stroke());
        }
      }
      f = {
          ...
          if (0 < r.length) {
            for (var q = !1, u = 0; u < r.length; u++)
              if (
                ...
                !(Q < a.axisX.dataInfo.viewPortMin || (Q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !q))))
              )
                if ('number' !== typeof r[u].y)
                  ...
                  D || q
                    ? (!D && k.connectNullData
                        ? (b.setLineDash &&
                            (k.options.nullDataLineDashType ||
                              (p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType)) &&
                            (b.stroke(),
                            b.beginPath(),
                            b.moveTo(h.x, h.y),
                    ...
                    : (b.lineTo(Q, H),
                      v && c.lineTo(Q, H),
                      0 == u % 500 &&
                        (b.stroke(), b.beginPath(), b.moveTo(Q, H), v && (c.stroke(), c.beginPath(), c.moveTo(Q, H))));
                  h = { x: Q, y: H };
                  u < r.length - 1 &&
                  ...
                  (r[u].indexLabel || k.indexLabel || r[u].indexLabelFormatter || k.indexLabelFormatter) &&
          ...
          if (0 < r.length)
            for (Q = !1, D = 0; D < r.length; D++)
              if (
                ...
                !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !Q))))
              )
                if ('number' !== typeof r[D].y)
                  0 < D &&
                    ...
                    (k.connectNullData
                      ? c.setLineDash &&
                        (0 < H.length && (k.options.nullDataLineDashType || !r[D - 1].lineDashType)) &&
                  ...
                  D < r.length - 1 &&
                    ...
                    c.setLineDash &&
                      (r[D].lineDashType
                        ? ((p = r[D].lineDashType), (H[H.length - 1].newLineDashArray = F(p, k.lineThickness)))
                  ...
                  (r[D].indexLabel || k.indexLabel || r[D].indexLabelFormatter || k.indexLabelFormatter) &&
                    this._indexLabels.push({
                      chartType: 'spline',
                      dataPoint: r[D],
                      dataSeries: k,
          ...
          if (0 < w.length)
            for (var m = 5 < p && d.bevelEnabled ? !0 : !1, g = 0; g < w.length; g++)
              if (
                ...
                h = a.axisX.reversed
                  ? (h + (a.plotType.totalDataSeries * p) / 2 - (a.previousDataSeriesCount + r) * p) << 0
                  : (h - (a.plotType.totalDataSeries * p) / 2 + (a.previousDataSeriesCount + r) * p) << 0;
          ...
          if (0 < w.length) {
            ...
            for (g = 0; g < w.length; g++)
              if (
                ...
                l = a.axisX.reversed
                  ? (l + (a.plotType.totalDataSeries * p) / 2 - (a.previousDataSeriesCount + r) * p) << 0
                  : (l - (a.plotType.totalDataSeries * p) / 2 + (a.previousDataSeriesCount + r) * p) << 0;
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (l[c] = u[k].y + (l[c] ? l[c] : 0)),
                    0 < l[c] && ((B = g[c] ? g[c] : n), (g[c] = r = a.axisY.convertValueToPixel(l[c])));
                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y)
                  (t[c] = u[k].y + (t[c] ? t[c] : 0)),
                    (r = h[c] ? h[c] : n),
                  ...
                  f || ca
                    ? (!f && w.connectNullData
                        ? (g.setLineDash &&
                          ...
                          g.lineTo(u, s),
                          v && h.lineTo(u, s))
                        : (g.beginPath(), g.moveTo(u, s), v && (h.beginPath(), h.moveTo(u, s)), (A = { x: u, y: s })),
                      (ca = f = !1))
              ...
              if (
                ...
                if ('number' !== typeof n[d].y)
                  ...
                  d < n.length - 1 &&
                    ...
                    c.setLineDash &&
                      (n[d].lineDashType
                        ? ((z = n[d].lineDashType), (q[q.length - 1].newLineDashArray = F(z, p.lineThickness)))
                  ...
                  : ((u = a.axisX.convertValueToPixel(q)),
                    ...
                    f || b
                      ? (!f && w.connectNullData
                          ? (g.setLineDash &&
                              (w.options.nullDataLineDashType ||
                                (K === w.lineDashType && w.lineDashType !== w.nullDataLineDashType)) &&
                              ((f = u),
                              (b = s),
                              (u = p.x),
                              (s = p.y),
                    ...
                    (p = { x: u, y: s }),
                    D < m.length - 1 &&
                      (L !== (m[D].lineColor || z) || K !== (m[D].lineDashType || w.lineDashType)) &&
                      (c(),
                      (L = m[D].lineColor || z),
                      (g.strokeStyle = L),
                      g.setLineDash &&
        ...
        for (y = 0; y < a.dataSeriesIndexes.length; y++) {
          ...
          if (0 < k.length) {
            ...
            for (var ca = !0, p = 0; p < k.length; p++) {
              ...
              if (
                !(w < a.axisX.dataInfo.viewPortMin || (w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ca)))
              )
                if ('number' !== typeof aa.y) A.connectNullData || (ca || s) || f(), (ca = !0);
                  ...
                  s || ca
                    ? (!s && A.connectNullData
                        ? (c.setLineDash &&
                            (A.options.nullDataLineDashType ||
                              (q === A.lineDashType && A.lineDashType !== A.nullDataLineDashType)) &&
                            ((s = t.pop()),
                            (q = t[t.length - 1]),
                            f(),
                            c.moveTo(u.x, u.y),
                    ...
                    : (c.lineTo(n, d),
                      v && D.lineTo(n, d),
                      0 == p % 250 && (f(), c.moveTo(n, d), v && D.moveTo(n, d), t.push({ x: n, y: m - wa })));
                  u = { x: n, y: d };
                  p < x.length - 1 &&
              ...
              if (
                ...
                if ('number' !== typeof aa.y) A.connectNullData || (ca || s) || f(), (ca = !0);
                  ...
                  s || ca
                    ...
                    : (c.lineTo(n, d),
                      v && y.lineTo(n, d),
                      0 == p % 250 && (f(), c.moveTo(n, d), v && y.moveTo(n, d), t.push({ x: n, y: q - ma })));
                  m = { x: n, y: d };
                  p < z.length - 1 &&
    ...
    q.prototype.renderBubble = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var w = 25 * Math.PI, m = Math.max(Math.pow((0.25 * Math.min(c.height, c.width)) / 2, 2) * Math.PI, w), k = 0;
          k < a.dataSeriesIndexes.length;
          k++
        )
          if (((r = a.dataSeriesIndexes[k]), (p = this.data[r]), (n = p.dataPoints), 0 < n.length))
            for (b.strokeStyle = '#4572A7 ', e = 0; e < n.length; e++)
              if (
                ...
                (n[e].indexLabel || p.indexLabel || n[e].indexLabelFormatter || p.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: 'bubble',
                    dataPoint: n[e],
                    dataSeries: p,
            ...
            for (var p = 0, n = 0, e = 0; e < r.length; e++)
              if (
                ...
                (Math.sqrt((p - g) * (p - g) + (n - h) * (n - h)) < Math.min(d.size, 5) &&
                  ...
                  (p = R(p)),
                  v && $.drawMarker(d.x, d.y, this._eventManager.ghostCtx, d.type, d.size, p, p, d.borderThickness),
                  (r[e].indexLabel || k.indexLabel || r[e].indexLabelFormatter || k.indexLabelFormatter) &&
                    this._indexLabels.push({
                      chartType: 'scatter',
                      dataPoint: r[e],
                      dataSeries: k,
                ...
                'candlestick' === u.type
                  ...
                  : 'ohlc' === u.type &&
                    ...
                    v &&
                      ...
                      c.lineTo(B, n),
                      c.stroke()));
                (q[l].indexLabel || u.indexLabel || q[l].indexLabelFormatter || u.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: u.type,
                    dataPoint: q[l],
                    dataSeries: u,
              ...
              if (
                ...
                v &&
                  ...
                  0 < K &&
                    ...
                    c.stroke()));
                (H[h].indexLabel || q.indexLabel || H[h].indexLabelFormatter || q.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: q.type,
                    dataPoint: H[h],
                    dataSeries: q,
            ...
            for (var w = 5 < k && n.bevelEnabled ? !0 : !1, g = 0; g < d.length; g++)
              if (
                ...
                var m = a.axisX.reversed
                    ? (c + (a.plotType.totalDataSeries * k) / 2 - (a.previousDataSeriesCount + r) * k) << 0
                    : (c - (a.plotType.totalDataSeries * k) / 2 + (a.previousDataSeriesCount + r) * k) << 0,
    ...
    q.prototype.renderRangeBar = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        r = this.options.dataPointWidth
          ...
          : (0.9 *
              ((e.height *
                (a.axisX.logarithmic ? Math.log(r) / Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range))) /
                a.plotType.totalDataSeries)) <<
            0;
        this.dataPointMaxWidth &&
          g > h &&
          ...
          if (0 < w.length) {
            ...
            for (g = 0; g < w.length; g++)
              if (
                ...
                t = a.axisX.reversed
                  ? (t + (a.plotType.totalDataSeries * r) / 2 - (a.previousDataSeriesCount + p) * r) << 0
                  : (t - (a.plotType.totalDataSeries * r) / 2 + (a.previousDataSeriesCount + p) * r) << 0;
                    ...
                    ? (r.connectNullData && !n
                        ? (c.setLineDash &&
                            (r.options.nullDataLineDashType ||
                              (A === r.lineDashType && r.lineDashType !== r.nullDataLineDashType)) &&
                            ((t[t.length - 1].newLineDashArray = C), (A = r.nullDataLineDashType), c.setLineDash(z)),
                          c.lineTo(w, m),
                          v && e.lineTo(w, m),
                          t.push({ x: w, y: q }))
                        : (c.beginPath(),
                      ...
                      (L = n = !1))
                    : (c.lineTo(w, m), t.push({ x: w, y: q }), v && e.lineTo(w, m), 0 == d % 250 && f());
                  u = r.dataPointIds[d];
                  this._eventManager.objectMap[u] = {
                    id: u,
                    objectType: 'dataPoint',
                  ...
                  d < p.length - 1 &&
                    ...
                    c.setLineDash &&
                      (p[d].lineDashType
                        ...
                        : ((A = r.lineDashType), (t[t.length - 1].newLineDashArray = C), c.setLineDash(C))));
              ...
              if (
                ...
                if (
                  ...
                  p < r.length - 1 &&
                    ...
                    c.setLineDash &&
                      (r[p].lineDashType
                        ? ((z = r[p].lineDashType), (m[m.length - 1].newLineDashArray = F(z, k.lineThickness)))
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? c.setLineDash &&
                        (0 < m.length && (k.options.nullDataLineDashType || !r[p - 1].lineDashType)) &&
    ...
    q.prototype.renderWaterfall = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        n = this.options.dataPointWidth
          ...
          : (0.6 *
              ((g.width *
                (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range))) /
                a.plotType.totalDataSeries)) <<
            0;
        this.dataPointMaxWidth &&
          h > t &&
            ...
            for (var y = 5 < n && m.bevelEnabled ? !0 : !1, x = !1, z = null, A = null, h = 0; h < q.length; h++)
              if ((q[h].getTime ? (r = q[h].x.getTime()) : (r = q[h].x), 'number' !== typeof q[h].y)) {
                ...
                var K,
                  L = l;
                K =
                  ('undefined' !== typeof q[h].isIntermediateSum && !0 === q[h].isIntermediateSum) ||
                ...
                0 < h &&
                  ...
                  b.lineTo(L, K - s),
                  0 < u && b.stroke(),
                  v && (c.beginPath(), c.moveTo(z, A - s), c.lineTo(L, K - s), 0 < u && c.stroke()));
                x = !1;
                z = la;
                A = 0 < q[h].y ? t : k;
                L = q[h].lineDashType
                ...
                (q[h].indexLabel || m.indexLabel || q[h].indexLabelFormatter || m.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: 'waterfall',
                    dataPoint: q[h],
                    dataSeries: m,
          ...
          for (f = 0; f < r.length; f++)
            (l = d[(e + f) % r.length]),
              1 < b &&
                ...
                (h <= b / 2 && !p ? ((l.hemisphere = 'left'), h++) : ((l.hemisphere = 'right'), (p = !0)));
        }
      }
      function b(a) {
          ...
          0 > b
            ...
            : 0 < b &&
              ...
              null !== n &&
                ...
                b - p < m &&
                  ((h = p), (n = g(n, h, f + 1)), +n.toFixed(v) < +h.toFixed(v) && (k = b > m ? b - m : p - (h - n)))));
          k &&
        ...
        for (var b = (a = 0), f = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < f); b++) {
                ...
                if (0 > B) {
                  ...
                  'right' === l.hemisphere
                    ? ((sa = g(a, y)),
                      (F = -1 * (B - sa)),
                      (J = g(z, F)),
                      +J.toFixed(v) < +F.toFixed(v) && +sa.toFixed(v) <= +y.toFixed(v) && g(a, -(F - J)))
                    : ((sa = g(z, y)),
                      (F = -1 * (B - sa)),
                      (J = g(a, F)),
                      +J.toFixed(v) < +F.toFixed(v) && +sa.toFixed(v) <= +y.toFixed(v) && g(z, -(F - J)));
                }
              }
            }
          } else
          ...
          for (a = 0; a < r.length; a++)
            if (((l = d[a]), (z = l.indexLabelTextBlock.measureText()), 0 !== z.height && 0 !== z.width))
              (z = z = 0),
                'right' === l.hemisphere
                  ? ((z = n.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width + p)), (z *= -1))
                  : (z = n.x1 - (l.indexLabelTextBlock.x - l.indexLabelTextBlock.width - p)),
                0 < z &&
                  (!h &&
                    l.indexLabelText &&
                    ((y = 'right' === l.hemisphere ? n.x2 - l.indexLabelTextBlock.x : l.indexLabelTextBlock.x - n.x1),
                  ...
                  Math.abs(l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - x.y) < A ||
                    Math.abs(l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 - x.y) < A) &&
                  ((z /= Math.abs(Math.cos(l.indexLabelAngle))), 9 < z && (z *= 0.3), z > f && (f = z)),
                (z = z = 0),
                0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI
                  ? ((z = n.y2 - (l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + 5)), (z *= -1))
                ...
                0 < z &&
                  ...
                  Math.abs(l.indexLabelTextBlock.x - x.x) < A &&
                    ((z /= Math.abs(Math.sin(l.indexLabelAngle))), 9 < z && (z *= 0.3), z > f && (f = z)));
              ...
              if (((g = !1), (u = d[h]), u.indexLabelText)) {
                ...
                if (null !== k) {
                  ...
                  if ((n = 0 > B)) {
                    ...
                    n =
                      u.indexLabelTextBlock.x + u.indexLabelTextBlock.width < l.indexLabelTextBlock.x - p ||
                      n > q + p ||
                      t > s + p ||
                      m < w - p
                        ? !1
        ...
        for (var B = 0; B < r.length; B++)
          (z += Math.abs(r[B].y)),
            !a &&
              ...
              (a = !0),
            !a &&
              ('undefined' !== typeof r[B].label && null !== r[B].label && 0 < r[B].label.toString().length) &&
              (a = !0);
        if (0 !== z) {
          ...
          this._animator.animate(
            ...
            function(a) {
              ...
              for (b = 0; b < r.length; b++) {
                ...
                e > c &&
                  pa(t.plotArea.ctx, d[b].center, d[b].radius, g, k.type, c, e, k.fillOpacity, d[b].percentInnerRadius);
                if (f) break;
              }
              l();
            },
        ...
        if (u && x) {
          ...
          for (var B = 0, ya = x.length - 1; B < x.length || 0 <= ya; B++, ya--) {
            ...
            'inside' === u.indexLabelPlacement &&
              ((w[B] = B !== fa ? (u.reversed ? N[B].x2 - N[B].x1 : N[B].x3 - N[B].x4) : N[B].x3 - N[B].x6),
              20 > w[B] &&
                ((w[B] = B !== fa ? (u.reversed ? N[B].x3 - N[B].x4 : N[B].x2 - N[B].x1) : N[B].x2 - N[B].x1),
                (w[B] /= 2)));
        ...
        if (e)
          for (h = G.length - 1; 0 <= h; h--)
            (a = N[h]),
              ...
              u.reversed
                ? (G[h].textBlock.y + G[h].height > T + C && (G[h].textBlock.y = T + C - G[h].height),
                  G[h].textBlock.y < ra - C && (G[h].textBlock.y = ra - C))
                : (G[h].textBlock.y < T - C && (G[h].textBlock.y = T - C),
                  G[h].textBlock.y + G[h].height > ra + C && (G[h].textBlock.y = ra + C - G[h].height));
      }
      function g() {
        var a, b, c, e;
          ...
          for (var f = 0; f < N.length; f++)
            0 == G[f].textBlock.text.length
              ...
              : ((a = N[f]),
                ...
                u.reversed
                  ? (G[f].textBlock.y + G[f].height > T + C && (G[f].textBlock.y = T + C - G[f].height),
                    G[f].textBlock.y < ra - C && (G[f].textBlock.y = ra - C))
                  : (G[f].textBlock.y < T - C && (G[f].textBlock.y = T - C),
                    G[f].textBlock.y + G[f].height > ra + C && (G[f].textBlock.y = ra + C - G[f].height)));
        else
      ...
      function h() {
            ...
            for (var r = G.length - 1; 0 <= r; r--)
              !G[r].isDirty &&
                ...
                !(k >= G.length - 1) &&
                  ...
                  (G[r].textBlock.y =
                    G[r].textBlock.y + G[r].height - e > e - G[r].textBlock.y ? e + 1 : e - G[r].height - 1));
          }
        ...
        for (var d, e, f, g, h, k, t = 1, r = 0; r < 2 * t; r++) {
          for (
            var m = G.length - 1;
            0 <= m &&
            !((previousTextBlock = (previousLabel = 0 <= p(m) ? G[p(m)] : null) ? previousLabel.textBlock : null),
            (f = G[m]),
            (g = f.textBlock),
            ...
            !f.isDirty &&
              ...
              ((d = g.y + d + ga - k.y), (e = a(m, -d)), e < d && (0 < e && (d -= e), (e = a(n(m), d)), e != d)));
            m--
          );
          b();
        }
        ...
        for (
          ...
          if (
            (!L &&
              ...
              (L = !0),
            !L &&
              ('undefined' !== typeof x[K].label && null !== x[K].label && 0 < x[K].label.toString().length) &&
              (L = !0),
            (!L && 'function' === typeof u.indexLabelFormatter) || 'function' === typeof x[K].indexLabelFormatter)
          )
            L = !0;
        ...
        if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
          ...
          'funnel' === u.type
            ? ((P = y(u.options.neckHeight) ? 0.35 * J : u.neckHeight),
              ...
              'string' === typeof P && P.match(/%$/) ? ((P = parseInt(P)), (P = (P * J) / 100)) : (P = parseInt(P)),
          ...
          if (-1 !== K) {
            ...
            if (L && u.visible && (c(), g(), e(), 'inside' !== u.indexLabelPlacement)) {
              ...
              for (E = 0; E < x.length; E++)
                G[E].isDirty ||
                  ((a = G[E].textBlock.x + G[E].width), (a = (S - a) / 2), 0 == E && (A = a), A > a && (A = a));
            ...
            L &&
              u.visible &&
              ('inside' === u.indexLabelPlacement || s.animationEnabled || r(R), s.animationEnabled || m());
            if (!L)
              for (E = 0; E < x.length; E++)
                (A = u.dataPointIds[E]),
                  (a = {
            ...
            var d = (n.legendMarkerType = n.legendMarkerType
              ...
              m = n.legendText
                ...
                : this.itemTextFormatter
                  ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: null })
                  : n.name,
              ...
              var z = n.dataPoints[x],
                ...
                m = z.legendText
                  ...
                  : n.legendText
                    ? n.legendText
                    : this.itemTextFormatter
                      ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: z })
                      : z.name
                        ? z.name
                        : 'DataPoint: ' + (x + 1),
        ...
        (this.axisX.logarithmic
          ? ((r = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x)),
            (r =
              1 < r
                ? Math.min(
                    Math.max((((this.dataPoints.length - 1) / r) * Math.log(a / this.dataPoints[0].x)) >> 0, 0),
          ...
          : ((r = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (r =
              0 < r
                ? Math.min(
                    Math.max((((this.dataPoints.length - 1) / r) * (a - this.dataPoints[0].x)) >> 0, 0),
                    this.dataPoints.length,
                  )
                : 0)));
      for (;;) {
    ...
    S.prototype.getDataPointAtXY = function(a, f, b) {
      ...
      if ('none' !== this.chart.plotInfo.axisPlacement)
        if (
          ((p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: f })),
          this.axisX.logarithmic)
        )
          var n = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
            p =
              1 < n
                ? Math.min(
                    Math.max((((this.dataPoints.length - 1) / n) * Math.log(p / this.dataPoints[0].x)) >> 0, 0),
                    this.dataPoints.length,
                  )
                : 0;
        else
          (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (p =
              0 < n
                ? Math.min(
                    Math.max((((this.dataPoints.length - 1) / n) * (p - this.dataPoints[0].x)) >> 0, 0),
                    this.dataPoints.length,
                  )
                : 0);
      for (;;) {
            ...
            switch (this.type) {
              ...
              case 'pyramid':
                ...
                f > m.y1 &&
                  ...
                  a > g &&
                    a < m &&
                    (c.push({ dataPoint: d, dataPointIndex: n.dataPointIndex, dataSeries: this, distance: 0 }),
                    (l = !0)));
                break;
              case 'boxAndWhisker':
                if (
    ...
    C.prototype.createLabels = function() {
      ...
      if ('axisX' !== this.type || 'dateTime' !== this.valueType || this.logarithmic) {
        ...
        if (this.logarithmic && !this.equidistantInterval)
          for (
            this.logLabelValues || ((this.logLabelValues = []), this.createExtraLabelsForLog()), c = 0, d = n;
            ...
            for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
              if (!this._labels[b].breaksLabelType) {
                ...
                if (y(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                      ...
                      : y(this.options.labelMaxWidth)
                        ? ((this.sessionVariables.labelWrap = this.labelWrap),
                          ...
                          (q.width + f.width) >> 0 > 2 * g &&
                            ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = m)))
                        : ((this.sessionVariables.labelAngle =
                            this.sessionVariables.labelMaxWidth > g ? -25 : this.sessionVariables.labelAngle),
                          (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth),
                          (this.sessionVariables.labelMaxHeight = h),
                    ...
                    if (y(this.options.labelWrap))
                      if (!y(this.options.labelMaxWidth))
                        ...
                        if (((c = (q.width + f.width) >> 0), (d = this.labelFontSize), n < g))
                          ...
                          s === b &&
                          ((0 === s && n + this._labels[s + 1].textBlock.measureText().width - 2 * g > p) ||
                  ...
                  (m =
                    0 != this.labelAngle
                      ? (k - (t + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) /
                        Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))
                      : g),
    ...
    C.setLayoutAndRender = function(a, f, b, c, e, g) {
      ...
      for (
        var x = (s = 0), u = 0, z = 0, C = 0, F = 0, B = 0, A, I, J = (l = 0), L, K, O, q = (L = K = O = !1), d = 0;
        d < n.length;
        d++
      )
        n[d] &&
      ...
      if ('normal' === e) {
        for (var z = [], C = [], F = [], B = [], P = [], R = [], S = [], T = []; 4 > s; ) {
          ...
          if (a && 0 < a.length)
            for (d = 0; d < a.length; d++)
              a[d] &&
                ...
                a[d] &&
                  ...
                  0 < a[d].labelAngle
                    ...
                    : 0 > a[d].labelAngle
                      ...
                      : 0 === a[d].labelAngle &&
                        (I + u > t && (l = I + u / 2 - t - ba),
                        A - x < h && A - x < a[d].viewportMinimum && (J = h - M - a[d].tickLength - F - A + x / 2)),
                  ...
                  0 < l
                    ...
                    : a[d].viewportMaximum === a[d].maximum &&
                      ...
                      : a[d].viewportMaximum === a[d].maximum &&
                        ...
                        0 === a[d].labelAngle &&
                        (0 < J && (h += J), 0 < l && (t -= l))),
                m.panEnabled ? (Z = m.sessionVariables.axisX.height) : (m.sessionVariables.axisX.height = Z),
                ...
                (a[d].bounds = { x1: h, y1: l, x2: t, y2: k - (Z + e - z[d] - E), width: t - h, height: k - l })),
                (E += z[d] + a[d].margin);
          if (f && 0 < f.length)
            for (d = 0; d < f.length; d++)
              (f[d].lineCoordinates.x1 = Math.round(g.x1 + N + M)),
                (f[d].lineCoordinates.x2 = Math.round(g.x2 - ba - $ > m.width - 10 ? m.width - 10 : g.x2 - ba - $)),
                (f[d].lineCoordinates.width = Math.abs(t - h)),
                f[d]._labels &&
                  ...
                  (u =
                    ...
                    (l.textBlock.height - l.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(l.textBlock.angle)))),
                m.panEnabled ? (V = m.sessionVariables.axisX2.height) : (m.sessionVariables.axisX2.height = V),
                (l = Math.round(g.y1)),
                (k = Math.round(g.y2 + f[d].margin)),
                (f[d].lineCoordinates.y1 = l + V + W - U),
                (f[d].lineCoordinates.y2 = l),
                (f[d].bounds = { x1: h, y1: l + (V + W - C[d] - U), x2: t, y2: k, width: t - h, height: k - l }),
                (U += C[d] + f[d].margin);
          if (b && 0 < b.length)
            for (d = 0; d < b.length; d++)
              (M = 10),
                b[d] &&
                  ...
                  (b[d].lineCoordinates = { x1: t - Y, y1: l, x2: t - Y, y2: k, height: Math.abs(k - l) }),
                  (b[d].bounds = { x1: h - (F[d] + Y), y1: l, x2: t, y2: k, width: t - h, height: k - l }),
                  b[d].title &&
                ...
                (M =
                  0 < a.length
                    ...
                    : c[d]._labels && 0 < c[d]._labels.length
                      ...
                      : 0),
                (k = Math.round(g.y2 - (Z + e + M))),
                (c[d].lineCoordinates = { x1: h + X, y1: l, x2: h + X, y2: k, height: Math.abs(k - l) }),
                (c[d].bounds = { x1: h, y1: l, x2: t + (B[d] + X), y2: k, width: t - h, height: k - l }),
                c[d].title &&
          ...
          for (d = 0; d < n.length; d++)
            'axisY' === n[d].type &&
              (n[d].calculateValueToPixelConversionParameters(), n[d].calculateBreaksSizeInValues());
          if (0 < s) {
            if (a && 0 < a.length) for (d = 0; d < a.length; d++) q = P[s - 1][d] === P[s][d] ? !0 : !1;
            else q = !0;
            if (f && 0 < f.length) for (d = 0; d < f.length; d++) L = R[s - 1][d] === R[s][d] ? !0 : !1;
            else L = !0;
            if (b && 0 < b.length) for (d = 0; d < b.length; d++) K = S[s - 1][d] === S[s][d] ? !0 : !1;
            else K = !0;
            if (c && 0 < c.length) for (d = 0; d < c.length; d++) O = T[s - 1][d] === T[s][d] ? !0 : !1;
            else O = !0;
          }
          if (q && L && K && O) break;
          s++;
        ...
        for (S = []; 4 > s; ) {
            ...
            for (d = 0; d < b.length; d++)
              (b[d].lineCoordinates = {}),
                ...
                b[d].labelAutoFit &&
                  !y(z) &&
                  (0 < !a.length &&
                    (h = 0 > b[d].labelAngle ? Math.max(h, z) : 0 === b[d].labelAngle ? Math.max(h, z / 2) : h),
          ...
          if (c && 0 < c.length)
            for (d = 0; d < c.length; d++)
              (c[d].lineCoordinates = {}),
                (h = Math.round(g.x1 + Z + e)),
                (t = Math.round(g.x2 - V - W > c[d].chart.width - 10 ? c[d].chart.width - 10 : g.x2 - V - W)),
                c[d] &&
                  c[d].labelAutoFit &&
                  !y(F) &&
                  (0 < !a.length &&
                    (h = 0 < c[d].labelAngle ? Math.max(h, F) : 0 === c[d].labelAngle ? Math.max(h, F / 2) : h),
                  0 < !f.length && (t -= B / 2)),
          ...
          if (c && 0 < c.length)
            for (d = c.length - 1; 0 <= d; d--)
              c[d] &&
                ...
                (c[d].bounds = { x1: h, y1: l + (c[d].margin + U), x2: t, y2: k, width: t - h, height: N }),
                c[d].title &&
                  (c[d]._titleTextBlock.maxWidth =
                    0 < c[d].titleMaxWidth && c[d].titleMaxWidth < c[d].lineCoordinates.width
                      ? c[d].titleMaxWidth
            ...
            for (d = 0; d < a.length; d++) {
              ...
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] &&
                    b[M].labelAutoFit &&
                    ((t = 0 > b[M].labelAngle ? Math.max(t, z) : 0 === b[M].labelAngle ? Math.max(t, z / 2) : t),
          ...
          if (0 < s) {
            ...
            if (f && 0 < f.length) for (d = 0; d < f.length; d++) L = S[s - 1][d] === S[s][d] ? !0 : !1;
            else L = !0;
            if (b && 0 < b.length) for (d = 0; d < b.length; d++) K = u[s - 1][d] === u[s][d] ? !0 : !1;
            else K = !0;
            if (c && 0 < c.length) for (d = 0; d < c.length; d++) O = P[s - 1][d] === P[s][d] ? !0 : !1;
            else O = !0;
          }
          if (q && L && K && O) break;
          s++;
              ...
              0 === p.textBlock.angle
                ...
                : ((n.x =
                    'inside' === this.labelPlacement
                      ...
                      : n.x -
                        (0 > this.labelAngle ? p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) : 0)),
                  (n.y =
                    'inside' === this.labelPlacement
                      ? 0 > this.labelAngle
                        ...
                        : n.y -
                          this.tickLength -
                          Math.abs(p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + 5)
                      : n.y +
                        this.tickLength +
                        Math.abs(
                          0 > this.labelAngle ? p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) - 5 : 5,
                        ))),
              (p.textBlock.x = n.x),
              (p.textBlock.y = n.y));
        'inside' === this.labelPlacement &&
                ...
                : ((n.x =
                  ...
                  (n.y =
                    'inside' === this.labelPlacement
                      ? 0 < this.labelAngle
                        ? n.y + this.tickLength + 5
                        : n.y - p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + this.tickLength + 5
                      : n.y -
                        (this.tickLength +
                ...
                ? ((p.textBlock.y = n.y),
                  (p.textBlock.x =
                    'inside' === this.labelPlacement
                      ...
                      : n.x - p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) - this.tickLength - 5))
                : ((p.textBlock.y =
                    'inside' === this.labelPlacement
                      ? n.y
          ...
          a > e[g].endValue ||
            (a <= e[g].startValue && f >= e[g].endValue
              ...
              : a > e[g].startValue && f >= e[g].endValue
                ...
                : a <= e[g].startValue && f < e[g].endValue
                  ? (b =
                      b - f + e[g].startValue + (e[g].size * (f - e[g].startValue)) / (e[g].endValue - e[g].startValue))
                  : !c &&
                    (a > e[g].startValue && f < e[g].endValue) &&
                                                                        ...
                                                                        : c / (1 * U.dayDuration) <= a
                                                                          ...
                                                                          : c / (2 * U.dayDuration) <= a
                                                                            ...
                                                                            : c / (4 * U.dayDuration) <= a
                                                                              ? ((this.interval = 4),
                                                                                (this.intervalType = 'day'))
                                                                              : c / (1 * U.weekDuration) <= a
                                                                                ? ((this.interval = 1),
                                                                                  (this.intervalType = 'week'))
                                                                                : c / (2 * U.weekDuration) <= a
                                                                                  ? ((this.interval = 2),
                                                                                    (this.intervalType = 'week'))
                                                                                  : c / (3 * U.weekDuration) <= a
                                                                                    ? ((this.interval = 3),
                                                                                      (this.intervalType = 'week'))
                                                                                    : c / (1 * U.monthDuration) <= a
                                                                                      ? ((this.interval = 1),
                                                                                        (this.intervalType = 'month'))
                                                                                      : c / (2 * U.monthDuration) <= a
                                                                                        ? ((this.interval = 2),
                                                                                          (this.intervalType = 'month'))
                                                                                        : c / (3 * U.monthDuration) <= a
                                                                                          ? ((this.interval = 3),
                                                                                            (this.intervalType =
                                                                                              'month'))
                                                                                          : c / (6 * U.monthDuration) <=
    ...
    ba.prototype.createUserOptions = function(a) {
      if ('undefined' !== typeof a || this.options._isPlaceholder) {
        ...
        this.options._isPlaceholder ||
          (Ca(this.parent[this.optionsName]), (f = this.parent.options[this.optionsName].indexOf(this.options)));
        ...
        if ('bottom' === this.scaleBreaks.parent._position || 'top' === this.scaleBreaks.parent._position)
          ...
          if (
            ...
            'left' === this.scaleBreaks.parent._position
              ...
              : ((c = this.chart.plotArea.x2), (h = (this.chart.plotArea.x1 - p / 2 + 0.5) << 0), (a *= -1)),
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          if ('rangeBar' === h[0].dataSeries.type || 'error' === h[0].dataSeries.type)
            for (
              var d = Math.abs(a - this.parent.convertValueToPixel(h[q].dataPoint.y[0])), s = 0, n = 0;
              n < h.length;
              n++
            )
            ...
            for (
              var d = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)), v = (s = 0), n = (q = 0);
              n < h.length;
              n++
            )
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
            ...
            for (
              var d = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)), u = (v = s = 0), n = 0;
              n < h.length;
              n++
            )
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
          ...
          if (
            ...
            for (
              d = Math.abs(f - this.parent.convertValueToPixel(h[0].dataPoint.y)), n = u = v = s = 0;
              n < h.length;
              n++
            )
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
          ...
          if (
            ...
            'waterfall' === this.parent.dataSeries[q].type
              ? ((h =
                  1 === r.lineWidth % 2
                    ? (this.parent.convertValueToPixel(m.dataSeries.dataPointEOs[m.index].cumulativeSum) << 0) + 0.5
                    : this.parent.convertValueToPixel(m.dataSeries.dataPointEOs[m.index].cumulativeSum) << 0),
                (l.text = this.labelFormatter
                  ? this.labelFormatter({
                      chart: this.chart,
                      axis: this.parent.options,
          ...
          if ('left' === this.parent._position || 'right' === this.parent._position) {
            ...
            if (u) {
              ...
              'dateTime' === this.parent.valueType
                ? (l.text = this.labelFormatter
                    ...
                    : y(this.options.label)
                      ? Aa(this.parent.convertPixelToValue(f), this.valueFormatString, this.chart._cultureInfo)
                      : this.label)
                : 'number' === this.parent.valueType &&
                  (l.text = this.labelFormatter
                    ? this.labelFormatter({
                    ...
                    : y(this.options.label)
                      ? V(this.parent.convertPixelToValue(f), this.valueFormatString, this.chart._cultureInfo)
                      : this.label);
            ...
            if ('bottom' === this.parent._position || 'top' === this.parent._position)
              (l.text = this.labelFormatter
                ...
                : y(this.options.label)
                  ? V(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo)
                  : this.label),
                (l.x = b - l.measureText().width / 2),
                l.x + l.width > this.chart.bounds.x2 && (l.x = this.chart.bounds.x2 - l.width),
                l.x < this.chart.bounds.x1 && (l.x = this.chart.bounds.x1),
          ...
          if (u) {
            ...
            'dateTime' === this.parent.valueType
              ? (l.text = this.labelFormatter
                  ...
                  : y(this.options.label)
                    ? Aa(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo)
                    : this.label)
              : 'number' === this.parent.valueType &&
                (l.text = this.labelFormatter
                  ? this.labelFormatter({
              ...
              for (var m = 0; m < this.chart.axisX.length; m++) {
                for (
                  ...
                  (k = this.chart.axisX[m].dataSeries[c].getDataPointAtX(h, b)) &&
                    0 <= k.index &&
                    ((k.dataSeries = this.chart.axisX[m].dataSeries[c]), null !== k.dataPoint.y && l.push(k));
                k = null;
              }
              ...
              for (m = 0; m < this.chart.axisX2.length; m++) {
                ...
                for (c = 0; c < this.chart.axisX2[m].dataSeries.length; c++)
                  (k = this.chart.axisX2[m].dataSeries[c].getDataPointAtX(h, b)) &&
                    0 <= k.index &&
                    ((k.dataSeries = this.chart.axisX2[m].dataSeries[c]), null !== k.dataPoint.y && l.push(k));
                k = null;
              }
          } else {
            l = [];
                        ...
                        : 'ohlc' === c.type
                          ...
                          : 'boxAndWhisker' === c.type
                            ? (f.save(),
                              ...
                              0 < e.lineThickness &&
                                (f.beginPath(), f.moveTo(e.x1, e.y5), f.lineTo(e.x2, e.y5), f.stroke()),
                              f.restore(),
                              (f.globalAlpha = 1))
                            : 'error' === c.type &&
                              z(
            ...
            null === c.toolTipContent ||
              ...
              'waterfall' === b.type
                ? (this.chart.axisX &&
                    ...
                    (g += m != b.axisXIndex ? (b.axisX.title ? b.axisX.title + '<br/>' : 'X:{axisXIndex}<br/>') : ''),
                  (g += c.toolTipContent
                    ? c.toolTipContent
                    : b.toolTipContent
                      ? b.toolTipContent
                ...
                : 'bubble' === b.type
                  ...
                  : 'rangeColumn' === b.type ||
                    ...
                    ? (this.chart.axisX &&
                        1 < this.chart.axisX.length &&
                        (g +=
                          m != b.axisXIndex ? (b.axisX.title ? b.axisX.title + '<br/>' : 'X:{axisXIndex}<br/>') : ''),
                      (g += c.toolTipContent
                        ? c.toolTipContent
                        : b.toolTipContent
                          ? b.toolTipContent
