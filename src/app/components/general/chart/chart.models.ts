...
export module CanvasJS {
  export interface Chart {
     ...
     */
    readonly toolTip: ChartToolTip | undefined;
    readonly axisX: ChartAxisX[] | undefined;
    readonly axisX2: ChartAxisX[] | undefined;
    readonly axisY: ChartAxisY[] | undefined;
    readonly axisY2: ChartAxisY[] | undefined;
    readonly stripLines: ChartStrip[] | undefined;
    readonly data: ChartDataSeries[] | undefined;
    /**
  ...
  export interface ChartTitle extends ChartTitleOptions {
    /**
  ...
  export interface ChartLegend extends ChartLegendOptions {
    /**
  ...
  export interface ChartStripLinesOptions {
    /**
  ...
  export interface ChartStrip extends ChartStripLinesOptions {
    /**
  ...
  export interface ChartAxisXOptions extends ChartAxisOptions {
    /**
  ...
  /**
   * What gets passed to the callback function
   */
  ...
  export interface ChartAxisX extends ChartAxisXOptions {
    /**
  ...
  export interface ChartAxisYOptions extends ChartAxisXOptions {
    /**
  ...
  export interface ChartAxisY extends ChartAxisYOptions {
    /**
     * Returns the specified property of Axis.
     * @param propertyName Name of the property.
     */
  ...
  export interface ChartToolTip extends ChartToolTipOptions {
    /**
     * Returns the specified property of legend.
     * @param propertyName Name of the property.
     */
  ...
  export interface ChartDataSeriesOptions extends ChartDataCommon {
    /**
  ...
  export interface ChartDataSeries extends ChartDataSeriesOptions {
    /**
