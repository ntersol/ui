...
export const isType = {
  ...
  ruleGroup: (content: any | any[]): content is Wizard.RuleGroup[] =>
  ...
  sectionControl: (content: any): content is Wizard.SectionControl =>
    content && content.src && content.position && content.routeStart,
};
