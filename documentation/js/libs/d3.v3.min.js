...
!(function() {
      ...
      if (Ao < 0) {
        ...
        if (u.scrollX || u.scrollY) {
          var o = (r = to
            .select('body')
            .append('svg')
            .style({ position: 'absolute', top: 0, left: 0, margin: 0, padding: 0, border: 'none' }, 'important'))[0][0].getScreenCTM();
          (Ao = !(o.f || o.e)), r.remove();
        }
      }
      return (
      ...
      (n.forEach(function(n) {
        if (!((t = n.length - 1) <= 0)) {
          ...
          var l = new Tt(e, n, null, !0),
            c = new Tt(e, null, l, !1);
          (l.o = c), u.push(l), o.push(c), (c = new Tt(r, null, (l = new Tt(r, n, null, !1)), !0)), (l.o = c), u.push(l), o.push(c);
        }
      }),
      o.sort(t),
      qt(u),
    ...
    return {
      ...
      point: function(u, o) {
        var a = u > 0 ? Lo : -Lo,
          l = so(u - e);
        so(l - Lo) < Co
          ? (n.point(e, (r = (r + o) / 2 > 0 ? Ro : -Ro)), n.point(i, r), n.lineEnd(), n.lineStart(), n.point(a, r), n.point(u, r), (t = 0))
          : i !== a &&
            l >= Lo &&
            (so(e - i) < Co && (e -= i * Co),
            so(u - a) < Co && (u -= a * Co),
      ...
      if (f)
        for (var s = c[0], h = s[0], p = s[1] / 2 + Lo / 4, g = Math.sin(p), d = Math.cos(p), v = 1; ; ) {
          ...
          var y = (n = c[v])[0],
            ...
            S = w > Lo,
            k = g * x;
          if ((da.add(Math.atan2(k * b * Math.sin(w), d * M + k * Math.cos(w))), (u += S ? _ + b * qo : _), S ^ (h >= e) ^ (y >= e))) {
            var N = mt(vt(s), vt(n));
            _t(N);
            var E = mt(i, N);
            _t(E);
  ...
  function Yt(n) {
      ...
      return {
        ...
        point: function(s, h) {
          ...
          if (
            ...
            (f = 0), d ? (n.lineStart(), (p = r(g, e)), n.point(p[0], p[1])) : ((p = r(e, g)), n.point(p[0], p[1]), n.lineEnd()), (e = p);
          else if (a && e && o ^ d) {
            var y;
            v & u ||
              !(y = r(g, e, !0)) ||
    ...
    function r(n, t, e) {
      ...
      if (!(v < 0)) {
        ...
        if (
          (!k && w < b && ((x = b), (b = w), (w = x)),
          N ? (k ? (b + w > 0) ^ (m[1] < (so(m[0] - M) < Co ? b : w)) : b <= m[1] && m[1] <= w) : (S > Lo) ^ (M <= m[0] && m[0] <= _))
        ) {
          var E = Mt(p, (-g + y) / d);
        ...
        C = {
          ...
          polygonEnd: function() {
            ...
            var t = l([n, r]),
              e = k && t,
              i = d.length;
            (e || i) && (a.polygonStart(), e && (a.lineStart(), c(null, null, 1, a), a.lineEnd()), i && Lt(d, u, t, c, a), a.polygonEnd()),
              (d = v = y = null);
          },
        };
      return C;
  ...
  function be() {
    function n(n, i) {
      var u = Math.sin((i *= Do)),
        ...
        a = so((n *= Do) - t),
        l = Math.cos(a);
      (Ha += Math.atan2(Math.sqrt((a = o * Math.sin(a)) * a + (a = r * u - e * o * l) * a), e * u + r * o * l)), (t = n), (e = u), (r = o);
    }
    var t, e, r;
  ...
  function Ke(n, t, e, r) {
    var i = new Ge(n, t);
    return (
      Ba.push(i), e && nr(i, n, t, e), r && nr(i, t, n, r), Wa[n.i].edges.push(new tr(i, n, t)), Wa[t.i].edges.push(new tr(i, t, n)), i
    );
  }
  function Qe(n, t, e) {
    var r = new Ge(n, null);
  ...
  function hr(n, t, e, r, i, u) {
    if (!n(t, e, r, i, u)) {
      var o = 0.5 * (e + i),
        a = 0.5 * (r + u),
        l = t.nodes;
      l[0] && hr(n, l[0], e, r, o, a), l[1] && hr(n, l[1], o, r, i, a), l[2] && hr(n, l[2], e, a, o, u), l[3] && hr(n, l[3], o, a, i, u);
    }
  }
  ...
  function hu(n, t, e, r, i) {
    var u = n[0] - t[0],
      ...
      A = S - g,
      C = k - d;
    return N * N + E * E > A * A + C * C && ((b = S), (w = k)), [[b - l, w - c], [(b * e) / x, (w * e) / x]];
  }
  function pu(n) {
    function t(t) {
      function o() {
  ...
  function qu(n) {
    for (var t, e, r, i, u = [], o = Lu(n), a = -1, l = n.length - 1; ++a < l; )
      (t = zu(n[a], n[a + 1])),
        so(t) < Co
          ? (o[a] = o[a + 1] = 0)
          : (i = (e = o[a] / t) * e + (r = o[a + 1] / t) * r) > 9 && ((i = (3 * t) / Math.sqrt(i)), (o[a] = i * e), (o[a + 1] = i * r));
    for (a = -1; ++a <= l; )
  ...
  function Du(n) {
    ...
    return (
      ...
      (t.interpolate = function(n) {
        return arguments.length
          ? ((l = 'function' == typeof n ? (a = n) : (a = wl.get(n) || gu).key), (c = a.reverse || a), (f = a.closed ? 'M' : 'L'), t)
          : l;
      }),
      (t.tension = function(n) {
    ...
    (_o.data = function(n, t) {
      function e(n, e) {
        ...
        if (t) {
          ...
          for (r = -1; ++r < s; )
            (i = y.get((v = t.call(e, (u = e[r]), r)))) ? !0 !== i && ((p[r] = i), (i.__data__ = u)) : (g[r] = H(u)), y.set(v, !0);
  ...
  (to.geo.bounds = (function() {
    ...
    return function(n) {
      ...
      return (x = M = null), f === 1 / 0 || s === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[f, s], [h, p]];
    };
  })()),
        ...
        (n.translate = function(t) {
          ...
          return (
            ...
            (r = o
              ...
              .clipExtent([[f - 0.425 * c + Co, s + 0.12 * c + Co], [f - 0.214 * c - Co, s + 0.234 * c - Co]])
              .stream(l).point),
            (i = a
              .translate([f - 0.205 * c, s + 0.212 * c])
              .clipExtent([[f - 0.214 * c + Co, s + 0.166 * c + Co], [f - 0.115 * c - Co, s + 0.234 * c - Co]])
              .stream(l).point),
            n
          );
        }),
  ...
  (to.geo.path = function() {
    function n(n) {
      return (
        n && ('function' == typeof a && u.pointRadius(+a.apply(this, arguments)), (o && o.valid) || (o = i(u)), to.geo.stream(n, o)),
        u.result()
      );
    }
    function t() {
    ...
    (to.geo.graticule = function() {
      ...
      return (
        ...
        n.majorExtent([[-180, -90 + Co], [180, 90 - Co]]).minorExtent([[-180, -80 - Co], [180, 80 + Co]])
      );
    }),
    ...
    ($a.clip = function(n) {
      for (var t, e, r, i, u, o, a = De(n), l = -1, c = this.length - De(this), f = this[c - 1]; ++l < c; ) {
        for (t = n.slice(), n.length = 0, i = this[l], u = t[(r = t.length - a) - 1], e = -1; ++e < r; )
          Te((o = t[e]), f, i) ? (Te(u, f, i) || n.push(Re(u, o, f, i)), n.push(o)) : Te(u, f, i) && n.push(Re(u, o, f, i)), (u = o);
        a && n.push(n[0]), (f = i);
      }
      return n;
    });
        ...
        if (
          ...
          if (n && n.C) n.C = !1;
            ...
            do {
              ...
              } else if (((t = i.L).C && ((t.C = !1), (i.C = !0), ur(this, i), (t = i.L)), (t.L && t.L.C) || (t.R && t.R.C))) {
          ...
          (t.triangles = function(n) {
            ...
            return (
              ar(e(n)).cells.forEach(function(e, r) {
                for (var i, u = e.site, o = e.edges.sort(Ve), a = -1, l = o.length, c = o[l - 1].edge, f = c.l === u ? c.r : c.l; ++a < l; )
                  c,
                    (i = f),
    ...
    (to.geom.quadtree = function(n, t, e, r, i) {
      function u(n) {
        ...
        if (null != t) (d = t), (v = e), (y = r), (m = i);
          ...
          for (p = 0; p < g; ++p)
            (f = n[p]).x < d && (d = f.x), f.y < v && (v = f.y), f.x > y && (y = f.x), f.y > m && (m = f.y), s.push(f.x), h.push(f.y);
        else
          for (p = 0; p < g; ++p) {
            var _ = +x((f = n[p]), p),
              b = +M(f, p);
    ...
    (to.layout.force = function() {
      ...
      return (
        (l.tick = function() {
          ...
          for (r = -1; ++r < b; )
            (l = x[r]).fixed ? ((l.x = l.px), (l.y = l.py)) : ((l.x -= (l.px - (l.px = l.x)) * s), (l.y -= (l.py - (l.py = l.y)) * s));
  ...
  (to.layout.histogram = function() {
    function n(n, u) {
      ...
      if (p > 0) for (u = -1; ++u < h; ) (a = c[u]) >= f[0] && a <= f[1] && (((o = l[to.bisect(s, a, 1, p) - 1]).y += g), o.push(n[u]));
      return l;
    }
    var t = !0,
      e = Number,
    ...
    (to.layout.tree = function() {
      ...
      function m(n) {
        if (null != w) {
          ...
          for (u = [n]; (t = u.pop()); ) {
            var f = t.t;
            (f.x = (f.x + a) * l), (f.y = f.depth * c), k && ((f.x_size *= l), (f.y_size *= c)), t.children && (u = u.concat(t.children));
          }
        } else x(n, -n.t.x);
      }
      function x(n, t) {
          ...
          for (n(h, (c.dx * c.dy) / e.value), f.area = 0; (l = h.length) > 0; )
            f.push((o = h[l - 1])),
              ...
              'squarify' !== p || (a = r(f, d)) <= g
                ? (h.pop(), (g = a))
                : ((f.area -= f.pop().area), i(f, d, c, !1), (d = Math.min(c.dx, c.dy)), (f.length = f.area = 0), (g = 1 / 0));
    ...
    function u() {
      ...
      var x,
        ...
        q = to
          ...
          .on('keyup.brush', d);
      if (
        (to.event.changedTouches ? q.on('touchmove.brush', v).on('touchend.brush', m) : q.on('mousemove.brush', v).on('mouseup.brush', m),
        k
          .interrupt()
          .selectAll('*')
          .interrupt(),
      ...
      (n.extent = function(t) {
        ...
        return arguments.length
          ...
          : (c &&
              (o
                ? ((e = o[0]), (r = o[1]))
                : ((e = s[0]), (r = s[1]), c.invert && ((e = c.invert(e)), (r = c.invert(r))), r < e && ((l = e), (e = r), (r = l)))),
            f &&
              (a
                ? ((i = a[0]), (u = a[1]))
                : ((i = h[0]), (u = h[1]), f.invert && ((i = f.invert(i)), (u = f.invert(u))), u < i && ((l = i), (i = u), (u = l)))),
