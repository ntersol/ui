...
declare namespace Microsoft.Maps.SpatialMath {
   ...
   **/
  export function getLengthOfPath(
    path: Location[],
    units?: DistanceUnits,
    highAccuracy?: boolean,
  ): number;
   ...
   **/
  export function getLocationAlongPath(
    path: Polyline | Location[],
    distance: number,
    units?: DistanceUnits,
  ): Location;
...
declare namespace Microsoft.Maps.SpatialMath.Tiles {
   ...
   **/
  export function groundResolution(
    latitude: number,
    zoom: number,
    units?: SpatialMath.DistanceUnits,
  ): number;
...
declare namespace Microsoft.Maps.SpatialMath.Geometry {
  ...
  export function buffer(
    shape: Location | IPrimitive | (Location | IPrimitive)[],
    distance: number,
    units?: DistanceUnits,
  ...
  export function contains(
    shapeA: Location | IPrimitive | (Location | IPrimitive)[],
   ...
   */
  export function snapLocationsToShape(
   ...
   * @param toleranceUnits The distance units of the tolerance value. Default: Meters
   */
  export function snapShapeToShape(
    shapeToSnap: IPrimitive | IPrimitive[],
    shape: IPrimitive | IPrimitive[],
    tolerance?: number,
    toleranceUnits?: DistanceUnits,
  ): void;
