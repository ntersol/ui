        ...
        (s.prototype.init = function(t, e) {
          ...
          (s.prototype.setCTM = function(t) {
            ...
            if (e || o) {
              if (
                (e &&
                  (this.options.beforeZoom(this.getRelativeZoom(), this.computeRelativeZoom(t.a)) === !1
                ...
                n === !1
                  ...
                  : i.isObject(n) &&
                    (n.x === !1 ? ((t.e = this.getPan().x), (s = !0)) : i.isNumber(n.x) && (t.e = n.x),
                    n.y === !1 ? ((t.f = this.getPan().y), (r = !0)) : i.isNumber(n.y) && (t.f = n.y)),
                  (s && r) || !this.isPanDifferent(t) ? (o = !1) : (this.updateCache(t), this.options.onPan(this.getPan()));
              }
      ...
      function(t, e, o) {
        ...
        (l.prototype.init = function(t, e) {
          ...
          (l.prototype.disableMouseWheelZoom = function() {
            this.options.mouseWheelZoomEnabled &&
              (n.off(this.options.eventsListenerElement || this.svg, this.wheelListener, !1), (this.options.mouseWheelZoomEnabled = !1));
          }),
          ...
          (l.prototype.zoomAtPoint = function(t, e, o) {
            ...
            o
              ? ((t = Math.max(this.options.minZoom * n.zoom, Math.min(this.options.maxZoom * n.zoom, t))), (t /= this.getZoom()))
              : this.getZoom() * t < this.options.minZoom * n.zoom
              ? (t = (this.options.minZoom * n.zoom) / this.getZoom())
              : this.getZoom() * t > this.options.maxZoom * n.zoom && (t = (this.options.maxZoom * n.zoom) / this.getZoom());
        ...
        var h = [],
          c = function(t, e) {
            ...
            for (var n = h.length - 1; n >= 0; n--) if (h[n].svg === o) return h[n].instance.getPublicInstance();
            return h.push({ svg: o, instance: new l(o, e) }), h[h.length - 1].instance.getPublicInstance();
          };
        e.exports = c;
      },
          ...
          (e.exports = {
            ...
            getOrCreateViewport: function(t, e) {
              ...
              return (
                ...
                ~l.indexOf('svg-pan-zoom_viewport') || (l.push('svg-pan-zoom_viewport'), o.setAttribute('class', l.join(' '))),
                o
              );
            },
        ...
        e.exports = (function() {
          function t(t, e, o) {
            var n = function(t) {
              ...
              return (
                'mousewheel' == u
                  ? ((o.deltaY = -0.025 * t.wheelDelta), t.wheelDeltaX && (o.deltaX = -0.025 * t.wheelDeltaX))
                  : (o.deltaY = t.detail),
                e(o)
              );
            };
            ...
            if ('svg' === e.tagName.toLowerCase()) o = e;
              ...
              if ('embed' !== e.tagName.toLowerCase())
                throw 'img' === e.tagName.toLowerCase()
                  ? new Error('Cannot script an SVG in an "img" element. Please use an "object" element or an in-line SVG.')
