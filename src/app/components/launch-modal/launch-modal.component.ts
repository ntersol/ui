...
export class LaunchModalComponent implements OnInit, OnDestroy {
  ...
  @Output()
  success: EventEmitter<any> = new EventEmitter(); // A method to emit events to pass up to parent
  @Output()
  dismiss: EventEmitter<any> = new EventEmitter(); // A method to emit events to pass up to parent
