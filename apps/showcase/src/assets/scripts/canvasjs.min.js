...
(function () {
  ...
  function Ha(p, t) {
    ...
    if (y(this.options.margin) && p.options.subtitles)
      for (var r = p.options.subtitles, v = 0; v < r.length; v++)
        if (
          ((y(r[v].horizontalAlign) && 'center' === this.horizontalAlign) ||
  ...
  var Y = 20,
    ...
    Sa = {
      ...
      subtitles: [
        { fontFamily: Ca, fontSize: z, fontColor: ga, fontWeight: 'normal', verticalAlign: 'top', margin: 5 },
      ],
      data: [
        {
  ...
  var Y = 20,
    ...
    Ya = {
      ...
      subtitles: [
        { fontFamily: x, fontSize: z, fontColor: '#3A3A3A', fontWeight: 'normal', verticalAlign: 'top', margin: 5 },
      ],
      data: [
        {
          indexLabelFontFamily: x,
  ...
  var Y = 20,
    ...
    wa = {
      ...
      dark2: {
        ...
        subtitles: [
          { fontFamily: x, fontSize: z, fontColor: ga, fontWeight: 'normal', verticalAlign: 'top', margin: 5 },
        ],
        toolbar: {
          backgroundColor: '#666666',
          backgroundColorOnHover: '#FF7372',
    ...
    ja = function (p) {
      for (var t = '', r = 0; r < p.length; r++)
        t += String.fromCharCode(Math.ceil(p.length / 57 / 5) ^ p.charCodeAt(r));
      return t;
    },
    cb =
      window &&
  ...
  U.prototype.setOptions = function (p, t) {
    if (ra[this._defaultsKey]) {
      var r = ra[this._defaultsKey],
        v;
      for (v in r)
        'publicProperties' !== v && r.hasOwnProperty(v) && (this[v] = p && v in p ? p[v] : t && v in t ? t[v] : r[v]);
    }
  };
  ...
  U.prototype.set = function (p, t, r) {
    ...
    if ('options' === p) this.createUserOptions(t);
      ...
      v.hasOwnProperty(p) ||
      (v.publicProperties && v.publicProperties.hasOwnProperty(p) && 'readWrite' === v.publicProperties[p])
    )
  ...
  U.prototype.addTo = function (p, t, v, y) {
    ...
    x.hasOwnProperty(p) ||
    (x.publicProperties && x.publicProperties.hasOwnProperty(p) && 'readWrite' === x.publicProperties[p])
  ...
  U.prototype.addEventListener = function (p, v, r) {
    p &&
      ...
      this._eventListeners[p].push({ context: r || this, eventHandler: v }));
  };
  ...
  Ka.Chart = (function () {
      ...
      if (a && f && b) {
        ...
        if (!e)
          try {
            ...
            (f = window.open()),
              f.document.write(
                "<img src='" + a + "'></img><div>Please right click on the image and save it to your device</div>",
              ),
              f.document.close();
          }
      }
      ...
      if (this.options.stripLines && 0 < this.options.stripLines.length)
        for (a = 0; a < this.options.stripLines.length; a++)
          this.stripLines.push(
            new ga(this.chart, this.options.stripLines[a], a, ++this.chart._eventManager.lastObjectId, this),
          );
      ...
      if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
        ...
        for (a = 0; a < this._appliedBreaks.length - 1; a++)
          this._appliedBreaks[a].endValue >= this._appliedBreaks[a + 1].startValue &&
            ...
            window.console &&
              window.console.log('CanvasJS Error: Breaks ' + a + ' and ' + (a + 1) + ' are overlapping.'),
    ...
    r.prototype._updateSize = function () {
      ...
      this.options.width
        ? (a = this.width)
        : (this.width = a = 0 < this.container.clientWidth ? this.container.clientWidth : this.width);
      this.options.height
        ? (f = this.height)
            ...
            if (this.options.axisY2 && 0 < this.options.axisY2.length) {
              if (!this.axisY2.length)
                for (b = 0; b < this.options.axisY2.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ? this._axes.push(
                        (this.axisY2[b] = new C(this, 'axisY2', this.options.axisY2[b], b, 'axisY', 'right')),
                      )
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push(
                        (this.axisY2[b] = new C(this, 'axisY2', this.options.axisY2[b], b, 'axisY', 'top')),
                      );
              this.data[a].axisY =
                this.axisY2[
            ...
            if (this.options.axisX && 0 < this.options.axisX.length) {
              if (!this.axisX.length)
                for (b = 0; b < this.options.axisX.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ? this._axes.push(
                        (this.axisX[b] = new C(this, 'axisX', this.options.axisX[b], b, 'axisX', 'bottom')),
                      )
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push(
                        (this.axisX[b] = new C(this, 'axisX', this.options.axisX[b], b, 'axisX', 'left')),
                      );
              this.data[a].axisX =
                this.axisX[
            ...
            if (this.options.axisX2 && 0 < this.options.axisX2.length) {
              if (!this.axisX2.length)
                for (b = 0; b < this.options.axisX2.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ? this._axes.push(
                        (this.axisX2[b] = new C(this, 'axisX2', this.options.axisX2[b], b, 'axisX', 'top')),
                      )
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push(
          ...
          s._animator.animate(
            ...
            function () {
              ...
              for (var a = 0; a < s.plotInfo.plotTypes.length; a++)
                for (var b = s.plotInfo.plotTypes[a], d = 0; d < b.plotUnits.length; d++)
    ...
    r.prototype.categoriseDataSeries = function () {
      for (var a = '', f = 0; f < this.data.length; f++)
        if (
          ((a = this.data[f]),
          a.dataPoints && 0 !== a.dataPoints.length && a.visible && 0 <= r._supportedChartTypes.indexOf(a.type))
        ) {
          ...
          for (m = 0; m < q.dataPoints.length; m++) {
            ...
            if (0 < m) {
              ...
              null !== e &&
                ...
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((v = e / q.dataPoints[m - 1].y), 1 > v && (v = 1 / v), f.minDiff > v && 1 !== v && (f.minDiff = v))
          ...
          for (q = 0; q < s.dataPoints.length; q++) {
            ...
            if (0 < q) {
              ...
              y(e) ||
                ...
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((u = e / s.dataPoints[q - 1].y), 1 > u && (u = 1 / u), f.minDiff > u && 1 !== u && (f.minDiff = u))
    ...
    r.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g, h, l = !1, n = 0;
          ...
          for (s = 0; s < k.dataPoints.length; s++) {
            ...
            0 < s &&
              ...
              e &&
                null !== e[0] &&
                k.dataPoints[s - 1].y &&
                null !== k.dataPoints[s - 1].y[0] &&
                (a.axisY.logarithmic
                  ? ((w = e[0] / k.dataPoints[s - 1].y[0]),
                    1 > w && (w = 1 / w),
    ...
    r.prototype.calculateAutoBreaks = function () {
              ...
              if (!(4 > p.dataPoints.length))
                for (s = 0; s < p.dataPoints.length; s++)
                  if (
                    (c &&
                      ((q =
                        ((m + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                    ...
                    var r =
                      ((n + 1 - l) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100;
                    if ((k = 'waterfall' === a.type ? p.dataPointEOs[s].cumulativeSum : p.dataPoints[s].y) && k.length)
                      for (var t = 0; t < k.length; t++)
                        (q = Math.floor((k[t] - l) / r)),
                          k[t] < f[q].min && (f[q].min = k[t]),
                          k[t] > f[q].max && (f[q].max = k[t]);
                    else
                      y(k) ||
                        ((q = Math.floor((k - l) / r)), k < f[q].min && (f[q].min = k), k > f[q].max && (f[q].max = k));
                  }
            }
        }
      }
      function b(a) {
        if (
          ...
          for (
            var c = a.axisX.dataInfo, b = c.min, f = c.max, g = c._dataRanges, k, h = 0, m = 0;
              ...
              for (l in m)
                m.hasOwnProperty(l) &&
                  ...
                  y(q) ||
                    ...
                    q < s[index].min && (s[index].min = q),
                    q > s[index].max && (s[index].max = q)));
    ...
    r.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var h = ka('indexLabelFontWeight', k.dataPoint, k.dataSeries),
          ...
          c =
            0 < B
              ? Math.min(
                  10,
                  ('normal' === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0,
                )
              : 0,
        ...
        if (null !== F && '' !== F) {
            ...
            'inside' !== u
              ? ((e = b.y1),
                ...
                0 < r
                  ...
                  : ((m = k.point.y + h + c),
                    m > g - n - h - c &&
                      ((m = 'auto' === u ? Math.min(k.point.y, g) - n - h - c : g - n - h - c), (x = m < k.point.y))))
              ...
              'inside' !== u
                ? ((h = b.x1),
                  ...
                  0 > r
                    ? ((q = k.point.x - l - e - c),
                      q < h &&
                        ((q = 'auto' === u ? Math.max(k.point.x, h) + e + c : h + e + c), (x = q + l > k.point.x)))
                    : ((q = k.point.x + e + c),
                      q > g - l - e - c &&
                        ((q = 'auto' === u ? Math.min(k.point.x, g) - l - e - c : g - l - e - c), (x = q < k.point.x))))
          ...
          B &&
            'inside' !== u &&
            ((0 > s.indexOf('bar') && ('error' !== s || !k.axisSwapped) && k.point.x > b.x1 && k.point.x < b.x2) ||
              !x) &&
            ((0 > s.indexOf('column') && ('error' !== s || k.axisSwapped) && k.point.y > b.y1 && k.point.y < b.y2) ||
              !x) &&
            ((f.lineWidth = B),
          ...
          if (0 < s.length) {
            for (var r = !1, u = 0; u < s.length; u++)
              if (
                ...
                if ('number' !== typeof s[u].y)
                  0 < u && !(k.connectNullData || r || B) && (b.stroke(), v && c.stroke()), (r = !0);
                else {
                  ...
                  B || r
                    ? (!B && k.connectNullData
                        ? (b.setLineDash &&
                            (k.options.nullDataLineDashType ||
                              (q === k.lineDashType && k.lineDashType !== k.nullDataLineDashType)) &&
                            (b.stroke(),
                            b.beginPath(),
                            b.moveTo(h.x, h.y),
                    ...
                    : (b.lineTo(P, F),
                      v && c.lineTo(P, F),
                      0 == u % 500 &&
                        (b.stroke(), b.beginPath(), b.moveTo(P, F), v && (c.stroke(), c.beginPath(), c.moveTo(P, F))));
                  h = { x: P, y: F };
                  u < s.length - 1 &&
                ...
                if ('number' !== typeof s[B].y)
                  0 < B &&
                    ...
                    (k.connectNullData
                      ? c.setLineDash &&
                        0 < F.length &&
                        (k.options.nullDataLineDashType || !s[B - 1].lineDashType) &&
    ...
    r.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        q = this.dataPointWidth = this.options.dataPointWidth
          ...
          : (0.9 *
              ((e.width *
                (a.axisX.logarithmic ? Math.log(q) / Math.log(a.axisX.range) : Math.abs(q) / Math.abs(a.axisX.range))) /
    ...
    r.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        d = this.options.dataPointWidth
          ...
          : (0.9 *
              ((e.width *
                (a.axisX.logarithmic ? Math.log(d) / Math.log(a.axisX.range) : Math.abs(d) / Math.abs(a.axisX.range))) /
                a.plotType.plotUnits.length)) <<
            0;
        this.dataPointMaxWidth &&
          k > s &&
          (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, s));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          s < k &&
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  a.axisY.logarithmic ||
                  (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)
                )
                  (l[c] = u[k].y + (l[c] ? l[c] : 0)),
                    0 < l[c] &&
    ...
    r.prototype.renderStackedBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          k > q &&
          (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, q));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          q < k &&
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (l[c] = u[k].y + (l[c] ? l[c] : 0)),
                    0 < l[c] && ((y = g[c] ? g[c] : m), (g[c] = s = a.axisY.convertValueToPixel(l[c])));
                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y)
                  (n[c] = u[k].y + (n[c] ? n[c] : 0)),
                    (s = h[c] ? h[c] : m),
            ...
            for (var ea = !0; B < p.length; B++)
              if (
                ...
                !(
                  ...
                  (r > a.axisX.dataInfo.viewPortMax && (!w.connectNullData || !ea))
                ))
              )
                    ...
                    ? (!f && w.connectNullData
                        ? (g.setLineDash &&
                            (w.options.nullDataLineDashType ||
                              (b === w.lineDashType && w.lineDashType !== w.nullDataLineDashType)) &&
                            ((f = u),
                            (b = t),
                            (u = q.x),
                            (t = q.y),
                ...
                if ('number' !== typeof m[d].y)
                  0 < d &&
                    ...
                    (q.connectNullData
                      ? c.setLineDash &&
                        0 < r.length &&
                        (q.options.nullDataLineDashType || !m[d - 1].lineDashType) &&
                  ...
                  : ((u = a.axisX.convertValueToPixel(r)),
                    ...
                    f || b
                      ? (!f && w.connectNullData
                          ? (g.setLineDash &&
                              (w.options.nullDataLineDashType ||
                                (J === w.lineDashType && w.lineDashType !== w.nullDataLineDashType)) &&
                              ((f = u),
                              (b = t),
                              (u = q.x),
                              (t = q.y),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], y = 0; y < a.dataSeriesIndexes.length; y++) {
          ...
          for (q = 0; q < z.length; q++)
            (x = z[q].x.getTime ? z[q].x.getTime() : z[q].x),
        ...
        for (y = 0; y < a.dataSeriesIndexes.length; y++) {
          ...
          if (0 < k.length) {
            ...
            for (var ea = !0, q = 0; q < k.length; q++) {
              ...
              if (
                !(w < a.axisX.dataInfo.viewPortMin || (w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ea)))
              )
                    ...
                    ? (!t && A.connectNullData
                        ? (c.setLineDash &&
                            (A.options.nullDataLineDashType ||
                              (r === A.lineDashType && A.lineDashType !== A.nullDataLineDashType)) &&
                            ((t = n.pop()),
                            (r = n[n.length - 1]),
                            f(),
                            c.moveTo(u.x, u.y),
    ...
    r.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], x = 0; x < a.dataSeriesIndexes.length; x++) {
          ...
          A.dataPointIndexes = [];
          for (q = 0; q < z.length; q++)
            (H = z[q].x.getTime ? z[q].x.getTime() : z[q].x),
              (A.dataPointIndexes[H] = q),
              e[H] || (k.push(H), (e[H] = !0));
          k.sort(Pa);
        }
                ...
                if ('number' !== typeof aa.y) A.connectNullData || ea || t || f(), (ea = !0);
                  ...
                  t || ea
                    ? (!t && A.connectNullData
                        ? (c.setLineDash &&
                            (A.options.nullDataLineDashType ||
                              (u === A.lineDashType && A.lineDashType !== A.nullDataLineDashType)) &&
                            ((t = n.pop()),
                            (u = n[n.length - 1]),
                            f(),
                            c.moveTo(p.x, p.y),
    ...
    r.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        w = this.options.dataPointWidth
          ...
          : (0.7 *
              h.width *
              (a.axisX.logarithmic ? Math.log(w) / Math.log(a.axisX.range) : Math.abs(w) / Math.abs(a.axisX.range))) <<
            0;
        this.dataPointMaxWidth &&
          e > g &&
    ...
    r.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        k = this.options.dataPointWidth
          ...
          : (0.9 *
              ((e.width *
                (a.axisX.logarithmic ? Math.log(k) / Math.log(a.axisX.range) : Math.abs(k) / Math.abs(a.axisX.range))) /
                a.plotType.totalDataSeries)) <<
            0;
        this.dataPointMaxWidth &&
          g > h &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0, u = 0; u < this.data.length; u++)
          !this.data[u].type.match(/(bar|column)/gi) ||
            !this.data[u].visible ||
            (this.data[u].type.match(/(stacked)/gi) && r) ||
            r++;
    ...
    r.prototype.renderRangeBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        s = this.options.dataPointWidth
          ...
          : (0.9 *
              ((e.height *
                (a.axisX.logarithmic ? Math.log(s) / Math.log(a.axisX.range) : Math.abs(s) / Math.abs(a.axisX.range))) /
                a.plotType.totalDataSeries)) <<
            0;
        this.dataPointMaxWidth &&
          g > h &&
                    ...
                    ? (s.connectNullData && !m
                        ? (c.setLineDash &&
                            (s.options.nullDataLineDashType ||
                              (A === s.lineDashType && s.lineDashType !== s.nullDataLineDashType)) &&
            ...
            for (d = !1; q < s.length; q++)
              if (
                ...
                if (
                  null !== s[q].y &&
                  s[q].y.length &&
                  'number' === typeof s[q].y[0] &&
                  'number' === typeof s[q].y[1]
                ) {
                  ...
                  0 < q &&
                    ...
                    (k.connectNullData
                      ? c.setLineDash &&
                        0 < p.length &&
                        (k.options.nullDataLineDashType || !s[q - 1].lineDashType) &&
    ...
    r.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        m = this.options.dataPointWidth
          ...
          : (0.6 *
              ((g.width *
                (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range))) /
                a.plotType.totalDataSeries)) <<
            0;
        this.dataPointMaxWidth &&
          h > n &&
          (h = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          n < h &&
            ...
            for (var y = 5 < m && p.bevelEnabled ? !0 : !1, x = !1, z = null, A = null, h = 0; h < r.length; h++)
              if ((r[h].getTime ? (s = r[h].x.getTime()) : (s = r[h].x), 'number' !== typeof r[h].y)) {
                if (0 < h && !x && p.connectNullData)
                  var C =
                    p.options.nullDataLineDashType || !r[h - 1].lineDashType
    ...
    r.prototype.renderPie = function (a) {
            ...
            ? ((m = 'right' === l.hemisphere ? q : n),
              ...
              null !== m &&
                ...
                b - q < w &&
                  ((h = -q),
                  (m = g(m, h, f + 1)),
                  +m.toFixed(t) > +h.toFixed(t) && (k = b > w ? -(b - w) : -(q - (m - h))))))
            : 0 < b &&
              ...
              null !== m &&
                ...
                b - q < w &&
                  ((h = q), (m = g(m, h, f + 1)), +m.toFixed(t) < +h.toFixed(t) && (k = b > w ? b - w : q - (h - m)))));
          k &&
              ...
              if (null !== x) {
                ...
                if (0 > z) {
                  for (var H = (y = 0), D = 0; D < s.length; D++)
                    D !== a &&
                      d[D].hemisphere === l.hemisphere &&
                      (d[D].indexLabelTextBlock.y < l.indexLabelTextBlock.y ? y++ : H++);
                  y = (z / (y + H || 1)) * H;
                  var H = -1 * (z - y),
                    Da = (D = 0);
                  'right' === l.hemisphere
              ...
              if (((g = !1), (u = d[h]), u.indexLabelText)) {
                ...
                if (null !== k) {
                  ...
                  m
                    ? (0 > a && (a = h),
                      k !== a && ((b = k), (f += -z)),
                      0 === h % Math.max(s.length / 10, 3) && (g = !0))
                    : (g = !0);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var z = 0; z < s.length; z++)
          (x += Math.abs(s[z].y)),
            !a &&
              'undefined' !== typeof s[z].indexLabel &&
              null !== s[z].indexLabel &&
              0 < s[z].indexLabel.toString().length &&
              (a = !0),
            !a &&
              'undefined' !== typeof s[z].label &&
              null !== s[z].label &&
              0 < s[z].label.toString().length &&
              (a = !0);
        if (0 !== x) {
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              for (b = 0; b < s.length; b++) {
                ...
                e > c &&
                  pa(n.plotArea.ctx, d[b].center, d[b].radius, g, k.type, c, e, k.fillOpacity, d[b].percentInnerRadius);
                if (f) break;
              }
              l();
            },
    ...
    var ra = function (a, f, b, c) {
      ...
      0 >= Math.round(f.y4 - f.y1) ||
        ...
        'undefined' !== f.x5 &&
          (a.lineTo(Math.round(f.x5), Math.round(f.y5)), a.lineTo(Math.round(f.x6), Math.round(f.y6))),
        a.closePath(),
    ...
    r.prototype.renderFunnel = function (a) {
      ...
      function c() {
        if (u && x) {
          for (
            ...
            (p = N[ca]),
              (p = 'undefined' !== typeof p.x5 ? (p.y2 + p.y4) / 2 : (p.y2 + p.y3) / 2),
              (p = d(p).x2 + 1),
              (w[ca] = R - p - V);
          p = 0.5 * V;
          for (var ca = 0, F = x.length - 1; ca < x.length || 0 <= F; ca++, F--) {
            ...
            'inside' === u.indexLabelPlacement &&
              ...
              20 > w[ca] &&
                ((w[ca] = ca !== ga ? (u.reversed ? N[ca].x3 - N[ca].x4 : N[ca].x2 - N[ca].x1) : N[ca].x2 - N[ca].x1),
                (w[ca] /= 2)));
        ...
        function b() {
          ...
          for (var k, l = 1; l < h; l++) {
            ...
            for (var s = G.length - 1; 0 <= s; s--)
              !G[s].isDirty &&
                G[s].textBlock.y < e &&
                G[s].textBlock.y + G[s].height > e &&
                ((k = m(s)),
                !(k >= G.length - 1) &&
                  G[s].textBlock.y + G[s].height + ha > G[k].textBlock.y &&
                  (G[s].textBlock.y =
                    G[s].textBlock.y + G[s].height - e > e - G[s].textBlock.y ? e + 1 : e - G[s].height - 1));
          }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          ...
          if (
            (!L &&
              'undefined' !== typeof x[J].indexLabel &&
              null !== x[J].indexLabel &&
              0 < x[J].indexLabel.toString().length &&
              (L = !0),
            !L &&
              'undefined' !== typeof x[J].label &&
              null !== x[J].label &&
              0 < x[J].label.toString().length &&
              (L = !0),
          ...
          if (-1 !== J) {
            ...
            if (u.reversed)
              for (E = 0; E < J.length; E++)
                I[E] < ba
                  ? (a.push(M), H.push(Z), (ga = E))
                  : (a.push((I[E] - U + fa * W) / fa), H.push((I[E] - U + ia * X) / ia));
            else
              for (E = 0; E < J.length; E++)
                I[E] < ba
                  ? (a.push((I[E] - U + fa * W) / fa), H.push((I[E] - U + ia * X) / ia), (ga = E))
                  : (a.push(M), H.push(Z));
            ...
            for (E = 0; E < x.length; E++)
              x[E].exploded && ((J = !0), u.reversed ? $.push(x.length - 1 - E) : $.push(E));
            ...
            if (L && u.visible && (c(), g(), e(), 'inside' !== u.indexLabelPlacement)) {
              ...
              for (E = 0; E < x.length; E++)
                G[E].isDirty ||
                  ((a = G[E].textBlock.x + G[E].width), (a = (R - a) / 2), 0 == E && (A = a), A > a && (A = a));
            ...
            L &&
              u.visible &&
              ('inside' === u.indexLabelPlacement || t.animationEnabled || s(T), t.animationEnabled || p());
            if (!L)
              for (E = 0; E < x.length; E++)
                (A = u.dataPointIds[E]),
                  (a = {
            ...
            if (g.plotInfo.plotTypes[0].plotUnits[0].axisX && !g.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic)
              return ya(
                ...
                f.xValueFormatString
                  ...
                  ? b.xValueFormatString
                  : (b.xValueFormatString =
                      g.axisX && g.axisX.autoValueFormatString ? g.axisX.autoValueFormatString : 'DD MMM YY'),
                g._cultureInfo,
              );
          } else
            return ba(
          ...
          if ('pie' !== m.type && 'doughnut' !== m.type && 'funnel' !== m.type && 'pyramid' !== m.type) {
            var d = (m.legendMarkerType = m.legendMarkerType
              ...
              r = (m.legendMarkerColor = m.legendMarkerColor
                ...
                : m._colorSet[0]),
              t =
                m.markerSize || ('line' !== m.type && 'stepLine' !== m.type && 'spline' !== m.type)
        ...
        (this.axisX.logarithmic
          ...
          : ((s = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (s =
              0 < s
                ? Math.min(
                    Math.max((((this.dataPoints.length - 1) / s) * (a - this.dataPoints[0].x)) >> 0, 0),
                    this.dataPoints.length,
                  )
                : 0)));
      for (;;) {
    ...
    S.prototype.getDataPointAtXY = function (a, f, b) {
      ...
      if ('none' !== this.chart.plotInfo.axisPlacement)
        if (
          ((q = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: f })),
          this.axisX.logarithmic)
        )
          ...
          (m = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (q =
              0 < m
                ? Math.min(
                    Math.max((((this.dataPoints.length - 1) / m) * (q - this.dataPoints[0].x)) >> 0, 0),
                    this.dataPoints.length,
                  )
                : 0);
      for (;;) {
            ...
            switch (this.type) {
              ...
              case 'doughnut':
                ...
                p < m.radius &&
                  ...
                  p > r &&
                    p < t &&
                    (c.push({ dataPoint: d, dataPointIndex: g, dataSeries: this, distance: 0 }), (l = !0)));
                break;
              case 'funnel':
              case 'pyramid':
                p = m.funnelSection;
                f > p.y1 &&
                  ...
                  a > g &&
                    a < p &&
                    (c.push({ dataPoint: d, dataPointIndex: m.dataPointIndex, dataSeries: this, distance: 0 }),
                    (l = !0)));
                break;
              case 'boxAndWhisker':
                if (
        ...
        if (Math.log(this.range) / Math.log(f / this.viewportMinimum) < this.noTicks - 1) {
          for (
            var b = C.getNiceNumber(
                (f - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3),
                !0,
              ),
            ...
            for (b = 0; b < this._labels.length; b++)
              (a = this._labels[b].textBlock),
                (a.maxWidth = this.labelMaxWidth =
                  y(this.options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth),
                (a.fontSize = this.labelFontSize =
                  y(this.options.labelFontSize) ? this.sessionVariables.labelFontSize : this.options.labelFontSize),
                (a.angle = this.labelAngle =
                  y(this.options.labelAngle) ? this.sessionVariables.labelAngle : this.labelAngle),
                (a.wrap = this.labelWrap =
                  y(this.options.labelWrap) ? this.sessionVariables.labelWrap : this.options.labelWrap),
                (a.maxHeight = this.sessionVariables.labelMaxHeight),
                a.measureText();
        else if ('left' === this._position || 'right' === this._position)
          if (
    ...
    C.setLayoutAndRender = function (a, f, b, c, e, g) {
      ...
      for (d = 0; d < m.length; d++)
        if (m[d] && m[d].scaleBreaks && m[d].scaleBreaks._appliedBreaks.length)
          for (
            var p = m[d].scaleBreaks._appliedBreaks, r = 0;
            r < p.length && !(p[r].startValue > m[d].viewportMaximum);
            r++
          )
      ...
      for (
        var t = (r = 0), u = 0, x = 0, z = 0, C = 0, D = 0, A, K, I = (l = 0), L, J, O, p = (L = J = O = !1), d = 0;
        d < m.length;
        d++
      )
        m[d] &&
        ...
        for (var x = [], z = [], C = [], D = [], Q = [], R = [], T = [], S = []; 4 > r; ) {
          ...
          if (b && 0 < b.length)
            for (C = [], d = N = 0; d < b.length; d++)
              C.push(Math.ceil(b[d] ? b[d].createLabelsAndCalculateWidth() : 0)),
                (N += C[d]),
                (M += b[d] ? b[d].margin : 0);
          ...
          if (c && 0 < c.length)
            for (D = [], d = ba = 0; d < c.length; d++)
              D.push(Math.ceil(c[d] ? c[d].createLabelsAndCalculateWidth() : 0)),
                (ba += D[d]),
                ($ += c[d] ? c[d].margin : 0);
                ...
                a[d] &&
                  ...
                  0 < a[d].labelAngle
                    ...
                    ? A - t < h &&
                      ...
                      (I = h - (M + a[d].tickLength + C + A - t + a[d].labelFontSize / 2))
                    : 0 === a[d].labelAngle &&
                      (K + u > n && (l = K + u / 2 - n - ba),
          ...
          for (d = 0; d < m.length; d++)
            'axisY' === m[d].type &&
              (m[d].calculateValueToPixelConversionParameters(), m[d].calculateBreaksSizeInValues());
          if (0 < r) {
        ...
        for (T = []; 4 > r; ) {
          ...
          if (a && 0 < a.length)
            for (t = [], d = Z = 0; d < a.length; d++)
              t.push(Math.ceil(a[d] ? a[d].createLabelsAndCalculateWidth() : 0)),
                (Z += t[d]),
                (e += a[d] ? a[d].margin : 0);
          ...
          if (f && 0 < f.length)
            for (K = [], d = Y = 0; d < f.length; d++)
              K.push(Math.ceil(f[d] ? f[d].createLabelsAndCalculateWidth() : 0)),
                (Y += K[d]),
                (X += f[d] ? f[d].margin : 0);
            ...
            for (d = 0; d < b.length; d++)
              (b[d].lineCoordinates = {}),
                ...
                b[d].labelAutoFit &&
                  !y(x) &&
                  (0 < !a.length &&
                    (h = 0 > b[d].labelAngle ? Math.max(h, x) : 0 === b[d].labelAngle ? Math.max(h, x / 2) : h),
            ...
            for (d = 0; d < c.length; d++)
              (c[d].lineCoordinates = {}),
                ...
                c[d] &&
                  ...
                  !y(C) &&
                  (0 < !a.length &&
                    (h = 0 < c[d].labelAngle ? Math.max(h, C) : 0 === c[d].labelAngle ? Math.max(h, C / 2) : h),
                  0 < !f.length && (n -= D / 2)),
            ...
            for (d = 0; d < a.length; d++) {
              ...
              if (c && 0 < c.length)
                for (M = 0; M < c.length; M++)
                  c[M] && c[M].labelAutoFit && ((n = c[M].lineCoordinates.x1), (h = n - Z));
          ...
          if (f && 0 < f.length)
            for (d = 0; d < f.length; d++) {
              ...
              if (c && 0 < c.length)
                for (M = 0; M < c.length; M++)
                  c[M] && c[M].labelAutoFit && ((n = c[M].lineCoordinates.x2), (h = n - Y));
        ...
        if (null !== this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
          ...
          this.stripLines[a].value = this.logarithmic
            ? this.stripLines[a].value *
              Math.sqrt(Math.log(this.stripLines[a].endValue / this.stripLines[a].startValue) / Math.log(f))
            : this.stripLines[a].value +
      ...
      if ('bottom' === this._position) {
                  ...
                  (m.y =
                    'inside' === this.labelPlacement
                      ? 0 > this.labelAngle
                        ...
                        : m.y -
                          this.tickLength -
                          Math.abs(q.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + 5)
                      : m.y +
                        this.tickLength +
                        Math.abs(
                          0 > this.labelAngle ? q.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) - 5 : 5,
                        ))),
              (q.textBlock.x = m.x),
              (q.textBlock.y = m.y));
        'inside' === this.labelPlacement &&
        ...
        this.title &&
          ...
          (this._titleTextBlock.x =
            this.lineCoordinates.x1 + this.lineCoordinates.width / 2 - this._titleTextBlock.width / 2),
        ...
        this.title &&
          ...
          (this._titleTextBlock.y =
            this.lineCoordinates.height / 2 + this._titleTextBlock.width / 2 + this.lineCoordinates.y1),
          (this.titleMaxWidth = this._titleTextBlock.maxWidth),
          this._titleTextBlock.render(!0));
    ...
    C.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (
          var f = this, b, c = 0, e = 0, g = !1, h = !1, l = [], n = [], h = !1, c = 0;
          ...
          k._thicknessType === a &&
            (('pixel' === a &&
              (k.value < this.viewportMinimum || k.value > this.viewportMaximum || y(k.value) || isNaN(this.range))) ||
              l.push(k));
        }
                ...
                0 === this.labelAngle
                  ...
                  : ((a.x -= 0 > this.labelAngle ? b.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) : 0),
                    (a.y +=
                      this.tickLength +
                      Math.abs(
                        0 > this.labelAngle ? b.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) - 5 : 5,
                      )));
              } else
                'top' === this._position
    ...
    C.prototype.convertPixelToValue = function (a) {
      ...
      if (this.logarithmic) {
        ...
        if (
          (b <= this.conversionParameters.reference === ('left' === this._position || 'right' === this._position)) !==
          this.reversed
        )
          for (b = 0; b < e.length; b++) {
            if (!(e[b].endValue < this.conversionParameters.minimum))
              if (f)
                ...
                if (c < e[b].size) {
                  a *=
                    Math.pow(e[b].endValue / e[b].startValue, 1 === e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) /
                    c;
                  break;
                } else a *= e[b].endValue / e[b].startValue / e[b].size;
                c /= e[b].size;
            ...
            if (!(e[b].endValue < this.conversionParameters.minimum))
              if (f)
                if (e[b].startValue < this.conversionParameters.minimum) {
                  if (
                    e[b].size &&
                    this.conversionParameters.minimum + (c * (e[b].endValue - e[b].startValue)) / e[b].size <
                      e[b].endValue
                  ) {
          ...
          a > e[g].endValue ||
            (a <= e[g].startValue && f >= e[g].endValue
              ...
              ? (b =
                  (b / e[g].endValue) *
                  a *
                  Math.pow(e[g].size, Math.log(e[g].endValue / a) / Math.log(e[g].endValue / e[g].startValue)))
              : a <= e[g].startValue && f <= e[g].endValue
              ? (b =
                  (b / f) *
                  e[g].startValue *
              ...
              ? ((c = c - a[e].endValue + this.viewportMinimum),
                (b =
                  0 < a[e].spacing.toString().indexOf('%')
                    ? b *
                      (1 -
                        ((parseFloat(a[e].spacing) / 100) * (a[e].endValue - this.viewportMinimum)) /
              ...
              : this.viewportMinimum <= a[e].startValue &&
                ...
                (b =
                  0 < a[e].spacing.toString().indexOf('%')
                    ? b *
                      (1 -
                        ((parseFloat(a[e].spacing) / 100) * (this.viewportMaximum - a[e].startValue)) /
                          (a[e].endValue - a[e].startValue))
                    : b -
    ...
    C.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        if ('axisX' === this.type) {
          ...
          0 === g - e &&
            ((c = 'undefined' === typeof this.options.interval ? 0.4 : this.options.interval), (g += c), (e -= c));
            ...
            ('axisX' === this.type
              ? ((e = null !== this.minimum ? this.minimum : this.dataInfo.min),
                ...
                0 === g - e &&
                  ...
                  (e -= c)),
                (h =
                  Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - e ? 0.5 * Math.abs(g - e) : 1))
              : 'axisY' === this.type &&
                ((e = null !== this.minimum ? this.minimum : this.dataInfo.min),
                (g = null !== this.maximum ? this.maximum : this.dataInfo.max),
                isFinite(e) || isFinite(g)
                  ...
                  : ((g = 'undefined' === typeof this.options.interval ? -Infinity : this.options.interval),
                    (e =
                      'undefined' !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity)),
                (h =
                  Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - e ? 0.5 * Math.abs(g - e) : 1),
      ...
      'axisX' === this.type
        ...
        : 'axisY' === this.type &&
          ...
          1 === c && 1 === e
            ...
            : 1 === e / c
            ? ((h = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))),
              (e *= h),
              (c /= h))
            : c > e
      ...
      if (
        ...
        if ('bottom' === this.scaleBreaks.parent._position || 'top' === this.scaleBreaks.parent._position)
          ...
          if (
            ...
            p = (h - n) / a / 3;
            for (m = 0; m < p; m++)
              this.ctx.bezierCurveTo(n + a, k + g * a, n + 2 * a, k + g * a, n + 3 * a, k), (n += 3 * a), (g *= -1);
    ...
    ga.prototype.createUserOptions = function (a) {
      if ('undefined' !== typeof a || this.options._isPlaceholder) {
        ...
        this.parent.options._isPlaceholder && this.parent.createUserOptions();
        this.options._isPlaceholder ||
          (Aa(this.parent.stripLines), (f = this.parent.options.stripLines.indexOf(this.options)));
        this.options = 'undefined' === typeof a ? {} : a;
    ...
    ha.prototype.render = function (a, f) {
      ...
      if ('left' === this.parent._position || 'right' === this.parent._position)
        (this.labelMaxWidth = y(this.options.labelMaxWidth)
          ...
          : this.labelMaxWidth),
          (this.labelMaxHeight =
            y(this.options.labelWrap) || this.labelWrap ? 3 * this.chart.height : 2 * this.labelFontSize);
        ...
        (this.labelMaxWidth = y(this.options.labelMaxWidth) ? 3 * this.chart.width : this.labelMaxWidth),
          (this.labelMaxHeight =
            y(this.options.labelWrap) || this.labelWrap ? this.parent.bounds.height : 2 * this.labelFontSize);
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          if ('rangeBar' === h[0].dataSeries.type || 'error' === h[0].dataSeries.type)
            for (
              var d = Math.abs(a - this.parent.convertValueToPixel(h[r].dataPoint.y[0])), t = 0, m = 0;
              m < h.length;
              m++
            )
            ...
            for (
              var d = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)), v = (t = 0), m = (r = 0);
              m < h.length;
              m++
            )
              if (h[m].dataPoint.y && h[m].dataPoint.y.length)
                ...
                (v += h[m].dataPoint.y),
                  (t = Math.abs(a - this.parent.convertValueToPixel(v))),
                  t < d && ((d = t), (r = m));
          else if ('stackedBar100' === h[0].dataSeries.type)
            for (
              var d = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)), u = (v = t = 0), m = 0;
              m < h.length;
              m++
            )
              if (h[m].dataPoint.y && h[m].dataPoint.y.length)
          ...
          if ('bottom' === this.parent._position || 'top' === this.parent._position) {
            ...
            if (u) {
              if ('axisX' === this.parent.type)
                for (
                  m = this.parent.convertPixelToValue({ y: f }), d = null, r = 0;
          ...
          if (u) {
            if ('axisX' === this.parent.type)
              for (
                m = this.parent.convertPixelToValue({ x: a }), d = null, r = 0;
                r < this.parent.dataSeries.length;
                r++
              )
                (d = this.parent.dataSeries[r].getDataPointAtX(m, !0)) &&
          ...
          if (
            ...
            for (d = Math.abs(f - this.parent.convertValueToPixel(h[0].dataPoint.y)), m = v = t = 0; m < h.length; m++)
              if (h[m].dataPoint.y && h[m].dataPoint.y.length)
                ...
                (v += h[m].dataPoint.y),
                  (t = Math.abs(f - this.parent.convertValueToPixel(v))),
                  t < d && ((d = t), (r = m));
          else if ('stackedColumn100' === h[0].dataSeries.type || 'stackedArea100' === h[0].dataSeries.type)
            for (
              d = Math.abs(f - this.parent.convertValueToPixel(h[0].dataPoint.y)), m = u = v = t = 0;
              m < h.length;
              m++
            )
              if (h[m].dataPoint.y && h[m].dataPoint.y.length)
          ...
          if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (n = 0; n < this.chart.axisX.length; n++)
                for (
                  h = this.chart.axisX[n].convertPixelToValue({ x: a }), k = null, c = 0;
                  c < this.chart.axisX[n].dataSeries.length;
                  c++
                )
                  (k = this.chart.axisX[n].dataSeries[c].getDataPointAtX(h, b)) &&
        ...
        if (0 < g.length && (this.highlightObjects(g), this.enabled))
          if (((b = ''), (b = this.getToolTipInnerHTML({ entries: g })), null !== b)) {
            ...
            'stackedBar100' === g[0].dataSeries.type
              ...
              : ((a = (g[0].dataSeries.axisX.convertValueToPixel(g[0].dataPoint.x) - this.container.clientWidth) << 0),
                (a -= 10));
            0 > a && (a += this.container.clientWidth + 20);
            a + this.container.clientWidth > Math.max(this.chart.container.clientWidth, this.chart.width) &&
              (a = Math.max(
                0,
                Math.max(this.chart.container.clientWidth, this.chart.width) - this.container.clientWidth,
              ));
            f =
              1 !== g.length ||
              this.shared ||
          ...
          !1 === g.highlightEnabled ||
            ...
            'rangeSplineArea' === c.type
              ...
              ? (f.save(),
                ...
                (f.globalAlpha = 1))
              : 'error' === c.type &&
                z(f, e.x1, e.y1, e.x2, e.y2, 'white', e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3));
        }
      }
      f.restore();
      f.globalAlpha = 1;
          ...
          (b = a[l].dataSeries),
            ...
            0 === l &&
              ...
              (this.chart.axisX && 0 < this.chart.axisX.length
                ? (k +=
                    'undefined' !== typeof this.chart.axisX[0].labels[c.x] ? this.chart.axisX[0].labels[c.x] : '{x}')
                : this.chart.axisX2 &&
                  0 < this.chart.axisX2.length &&
                  (k +=
                    'undefined' !== typeof this.chart.axisX2[0].labels[c.x] ? this.chart.axisX2[0].labels[c.x] : '{x}'),
              (k += '</br>'),
