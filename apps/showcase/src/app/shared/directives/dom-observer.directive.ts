 ...
 *
 * USAGE SHORT: ntsDomObserver [callback]="function.bind(this)"
 * USAGE FULL:
 * ntsDomObserver [callback]="function.bind(this)" [changesToAttr]="true" [changesToChildren]="false" [changesToData]="false"
   [changesToElementResize]="true"  [changesToWindowResize]="true"
 */
@Directive({
  selector: '[ntsDomObserver]',
})
