...
!(function(e, t) {
  ...
  var o = new Map(),
    a = (function() {
      function e(t, n, r) {
        ...
        i(this, e), (this.strings = t), (this.values = n), (this.type = r), (this.partCallback = o);
      }
      return (
        r(e, [
          {
            key: 'getHTML',
            value: function() {
              for (var e, t, n = this.strings.length - 1, r = '', i = !0, o = 0; o < n; o++) {
                var a = this.strings[o];
                r += a;
                var s = (void 0, void 0, (t = (e = a).lastIndexOf('>')), e.indexOf('<', t + 1) > -1 ? e.length : t);
        ...
        r(t, [
          {
            key: 'getHTML',
            value: function() {
              return '<svg>' + n(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'getHTML', this).call(this) + '</svg>';
            },
          },
          {
            key: 'getTemplateElement',
            value: function() {
              var e = n(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'getTemplateElement', this).call(this),
                r = e.content,
                i = r.firstChild;
  ...
  function l(e) {
    ...
    return void 0 === n && ((n = new v(e, e.getTemplateElement())), t.set(e.strings, n)), n;
  }
  ...
  var p = function e(t, n, r, o, a) {
      i(this, e), (this.type = t), (this.index = n), (this.name = r), (this.rawName = o), (this.strings = a);
    },
    v = function e(t, n) {
      i(this, e), (this.parts = []), (this.element = n);
      for (
        var r = this.element.content, o = document.createTreeWalker(r, 133, null, !1), a = -1, s = 0, l = [], c = void 0, v = void 0;
        o.nextNode();
        ...
        if (1 === d.nodeType) {
          ...
          for (var y = d.attributes, m = 0, _ = 0; _ < y.length; _++) y[_].value.indexOf(u) >= 0 && m++;
          for (; m-- > 0; ) {
            var g = t.strings[s],
              b = f.exec(g)[1],
              x = y.getNamedItem(b),
              N = x.value.split(h);
            this.parts.push(new p('attribute', a, x.name, b, N)), d.removeAttribute(x.name), (s += N.length - 1);
          }
          ...
          s += k;
          for (var O = 0; O < k; O++)
            w.insertBefore('' === V[O] ? document.createComment('') : document.createTextNode(V[O]), d),
              this.parts.push(new p('node', a++));
          w.insertBefore('' === V[k] ? document.createComment('') : document.createTextNode(V[k]), d), l.push(d);
        } else if (8 === d.nodeType && d.nodeValue === u) {
          var S = d.parentNode,
            C = d.previousSibling;
          null === C || C !== c || C.nodeType !== Node.TEXT_NODE ? S.insertBefore(document.createComment(''), d) : a--,
            this.parts.push(new p('node', a++)),
            l.push(d),
            null === d.nextSibling ? S.insertBefore(document.createComment(''), d) : a--,
            (v = c),
            s++;
        }
      }
      var P = !0,
        ...
        A = void 0;
      try {
        for (var E, M = l[Symbol.iterator](); !(P = (E = M.next()).done); P = !0) {
          var I = E.value;
        ...
        r(e, [
          {
            key: '_interpolate',
            value: function(e, t) {
              for (var n = this.strings, r = n.length - 1, i = '', o = 0; o < r; o++) {
                i += n[o];
                var a = d(this, e[t + o]);
                if (a && a !== m && (Array.isArray(a) || ('string' != typeof a && a[Symbol.iterator]))) {
                  var s = !0,
                    l = !1,
                    u = void 0;
                  try {
                    for (var c, h = a[Symbol.iterator](); !(s = (c = h.next()).done); s = !0) {
                      i += c.value;
                    }
                  } catch (e) {
                    (l = !0), (u = e);
          ...
          },
          {
            ...
            value: function(e, t) {
              for (var n = t; n < t + this.size; n++) if (this._previousValues[n] !== e[n] || !_(e[n])) return !1;
              return !0;
            },
          },
          {
    ...
    b = (function() {
      function e(t, n, r) {
        i(this, e), (this.instance = t), (this.startNode = n), (this.endNode = r), (this._previousValue = void 0);
      }
      return (
        r(e, [
          {
          ...
          },
          {
            ...
            value: function(e) {
              ...
              (e = void 0 === e ? '' : e),
                t === this.endNode.previousSibling && t.nodeType === Node.TEXT_NODE
                  ? (t.textContent = e)
          ...
          },
          {
            ...
            value: function(e) {
              ...
              this._previousValue && this._previousValue.template === t
                ...
                : ((n = new N(t, this.instance._partCallback, this.instance._getTemplate)),
          ...
          },
          {
            ...
            value: function(t) {
              ...
              try {
                for (var s, l = t[Symbol.iterator](); !(i = (s = l.next()).done); i = !0) {
                  ...
                  if (void 0 === c) {
                    ...
                    if (r > 0) (h = n[r - 1].endNode = document.createTextNode('')), this._insert(h);
              ...
              if (0 === r) this.clear(), (this._previousValue = void 0);
                ...
                var f = n[r - 1];
                (n.length = r), this.clear(f.endNode.previousSibling), (f.endNode = this.endNode);
              }
            },
          },
          {
    ...
    N = (function() {
      function e(t, n, r) {
        i(this, e), (this._parts = []), (this.template = t), (this._partCallback = n), (this._getTemplate = r);
      }
      return (
        r(e, [
          {
            ...
            value: function(e) {
              var t = 0,
                ...
                i = void 0;
              try {
                for (var o, a = this._parts[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                  var s = o.value;
                  void 0 === s.size ? (s.setValue(e[t]), t++) : (s.setValue(e, t), (t += s.size));
                }
              } catch (e) {
                (r = !0), (i = e);
              } finally {
          ...
          },
          {
            ...
            value: function() {
              ...
              if (t.length > 0)
                for (var n = document.createTreeWalker(e, 133, null, !1), r = -1, i = 0; i < t.length; i++) {
  ...
  (e.templateCaches = o),
    ...
    (e.render = function(e, t) {
      ...
      if (void 0 === i || i.template !== r || i._partCallback !== e.partCallback) {
